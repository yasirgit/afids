...
/**
 * ApplicationTemp form base class.
 *
 * @package    angelflight
 * @subpackage form
 ...
 */
class BaseApplicationTempForm extends BaseFormPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'fbo_name'                     => new sfWidgetFormInput(),
      ...
      'referral_source'              => new sfWidgetFormInput(),
      ...
      'referer_name'                 => new sfWidgetFormInput(),
      ...
      'is_complete'                  => new sfWidgetFormInput(),
    ...
    $this->setValidators(array(
      ...
      'ratings'                      => new sfValidatorString(array('max_length' => 80, 'required' => false)),
      ...
      'referral_source'              => new sfValidatorInteger(array('required' => false)),
      ...
      'is_complete'                  => new sfValidatorInteger(),
      'member_class_id'              => new sfValidatorInteger(array('required' => false)),
      'wing_id'                      => new sfValidatorInteger(array('required' => false)),
    ));

    $this->widgetSchema->setNameFormat('application_temp[%s]');
