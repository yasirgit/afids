 ...
 */
class BaseItineraryForm extends BaseFormPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'timetype'             => new sfWidgetFormInput(),
      'cancel_itinerary'     => new sfWidgetFormInput(),
      'copied_itinerary'     => new sfWidgetFormInput(),
    ));

    $this->setValidators(array(
      'id'                   => new sfValidatorPropelChoice(array('model' => 'Itinerary', 'column' => 'id', 'required' => false)),
      'date_requested'       => new sfValidatorDateTime(),
      'mission_request_id'   => new sfValidatorPropelChoice(array('model' => 'MissionRequest', 'column' => 'id', 'required' => false)),
      ...
      'timetype'             => new sfValidatorString(array('max_length' => 2, 'required' => false)),
      'cancel_itinerary'     => new sfValidatorInteger(array('required' => false)),
      'copied_itinerary'     => new sfValidatorString(array('max_length' => 15, 'required' => false)),
    ));

    $this->widgetSchema->setNameFormat('itinerary[%s]');
