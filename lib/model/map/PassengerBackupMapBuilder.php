...
/**
 * This class adds structure of 'passenger_backup' table to 'propel' DatabaseMap object.
 *
 *
 ...
 */
class PassengerBackupMapBuilder implements MapBuilder {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.PassengerBackupMapBuilder';
	...
	{
		$this->dbMap = Propel::getDatabaseMap(PassengerBackupPeer::DATABASE_NAME);

		$tMap = $this->dbMap->addTable(PassengerBackupPeer::TABLE_NAME);
		$tMap->setPhpName('PassengerBackup');
		$tMap->setClassname('PassengerBackup');
		...
		$tMap->addColumn('PASSENGER_TYPE_ID', 'PassengerTypeId', 'INTEGER', false, 11);
		...
		$tMap->addColumn('PASSENGER_ILLNESS_CATEGORY_ID', 'PassengerIllnessCategoryId', 'INTEGER', false, 4);
