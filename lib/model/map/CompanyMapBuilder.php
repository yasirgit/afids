...
class CompanyMapBuilder implements MapBuilder {
	...
	public function doBuild()
	{
		...
		$tMap->addColumn('HAS_MATCHING_PROGRAM', 'HasMatchingProgram', 'TINYINT', false, 1);

		$tMap->addColumn('HAS_PAYROLL_WITHHOLDING_PROGRAM', 'HasPayrollWithholdingProgram', 'TINYINT', false, 1);
