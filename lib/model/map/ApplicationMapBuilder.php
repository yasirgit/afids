...
class ApplicationMapBuilder implements MapBuilder {
	...
	public function doBuild()
	{
		...
		$tMap->addForeignKey('VOCATION_CLASS_ID', 'VocationClassId', 'INTEGER', 'vocation_class', 'ID', false, 4);

		$tMap->addColumn('COMPANY', 'Company', 'VARCHAR', false, 40);

		$tMap->addColumn('LICENSE_TYPE', 'LicenseType', 'VARCHAR', false, 10);

		$tMap->addColumn('IFR', 'Ifr', 'TINYINT', false, 1);

		$tMap->addColumn('MULTI_ENGINE', 'MultiEngine', 'TINYINT', false, 1);
		...
		$tMap->addColumn('FBO', 'Fbo', 'VARCHAR', false, 80);
		...
		$tMap->addColumn('MEMBER_MEETINGS', 'MemberMeetings', 'TINYINT', false, 1);
		...
		$tMap->addColumn('EXECUTIVE_BOARD', 'ExecutiveBoard', 'TINYINT', false, 1);

		$tMap->addColumn('WING_TEAM', 'WingTeam', 'TINYINT', false, 1);

		$tMap->addColumn('GRAPHIC_ARTS', 'GraphicArts', 'TINYINT', false, 1);

		$tMap->addColumn('OTHER_VOLUNTEER', 'OtherVolunteer', 'VARCHAR', false, 50);

		$tMap->addColumn('T_SHIRT_SIZE', 'TShirtSize', 'CHAR', false, 5);
		...
		$tMap->addColumn('SECONDARY_HOME_BASES', 'SecondaryHomeBases', 'VARCHAR', true, 30);
		...
		$tMap->addForeignKey('REFERRAL_SOURCE', 'ReferralSource', 'INTEGER', 'ref_source', 'ID', false, 11);
		...
		$tMap->addColumn('AIRCRAFT_THIRD_ID', 'AircraftThirdId', 'INTEGER', false, 11);
		...
		$tMap->addColumn('AIRCRAFT_THIRD_SEATS', 'AircraftThirdSeats', 'INTEGER', false, 11);
		...
		$tMap->addColumn('VETERAN', 'Veteran', 'TINYINT', false, 4);
