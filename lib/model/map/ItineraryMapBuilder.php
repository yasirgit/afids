...
/**
 * This class adds structure of 'itinerary' table to 'propel' DatabaseMap object.
 *
 *
 ...
 */
class ItineraryMapBuilder implements MapBuilder {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.ItineraryMapBuilder';
	...
	{
		$this->dbMap = Propel::getDatabaseMap(ItineraryPeer::DATABASE_NAME);

		$tMap = $this->dbMap->addTable(ItineraryPeer::TABLE_NAME);
		$tMap->setPhpName('Itinerary');
		$tMap->setClassname('Itinerary');
		...
		$tMap->addForeignKey('MISSION_REQUEST_ID', 'MissionRequestId', 'INTEGER', 'mission_request', 'ID', false, 11);
		...
		$tMap->addColumn('TIMETYPE', 'Timetype', 'VARCHAR', false, 2);

		$tMap->addColumn('CANCEL_ITINERARY', 'CancelItinerary', 'TINYINT', false, 4);

		$tMap->addColumn('COPIED_ITINERARY', 'CopiedItinerary', 'VARCHAR', false, 15);
