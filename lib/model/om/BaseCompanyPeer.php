...
abstract class BaseCompanyPeer {
	...
	/** the column name for the HAS_MATCHING_PROGRAM field */
	const HAS_MATCHING_PROGRAM = 'company.HAS_MATCHING_PROGRAM';

	/** the column name for the HAS_PAYROLL_WITHHOLDING_PROGRAM field */
	const HAS_PAYROLL_WITHHOLDING_PROGRAM = 'company.HAS_PAYROLL_WITHHOLDING_PROGRAM';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'HasMatchingProgram', 'HasPayrollWithholdingProgram', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'hasMatchingProgram', 'hasPayrollWithholdingProgram', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NAME, self::HAS_MATCHING_PROGRAM, self::HAS_PAYROLL_WITHHOLDING_PROGRAM, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'has_matching_program', 'has_payroll_withholding_program', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'HasMatchingProgram' => 2, 'HasPayrollWithholdingProgram' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'hasMatchingProgram' => 2, 'hasPayrollWithholdingProgram' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NAME => 1, self::HAS_MATCHING_PROGRAM => 2, self::HAS_PAYROLL_WITHHOLDING_PROGRAM => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'has_matching_program' => 2, 'has_payroll_withholding_program' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(CompanyPeer::HAS_MATCHING_PROGRAM);

		$criteria->addSelectColumn(CompanyPeer::HAS_PAYROLL_WITHHOLDING_PROGRAM);
