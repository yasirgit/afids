...
abstract class BaseEmailQueue extends BaseObject  implements Persistent {
  ...
  const PEER = 'EmailQueuePeer';
	...
	/**
	 * The value for the send_status field.
	...
	/**
	 * Get the [send_status] column value.
	 * 
	 * @return     string
	 */
	...
	public function setPersonId($v)
	{
		...
		if ($this->person_id !== $v) {
			$this->person_id = $v;
			$this->modifiedColumns[] = EmailQueuePeer::PERSON_ID;
		}
	...
	public function setLetterId($v)
	{
		...
		if ($this->letter_id !== $v) {
			$this->letter_id = $v;
			$this->modifiedColumns[] = EmailQueuePeer::LETTER_ID;
		}
	...
	public function setRequestDate($v)
	{
		...
		if ( $this->request_date !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = EmailQueuePeer::REQUEST_DATE;
			}
	...
	public function setSendDate($v)
	{
		...
		if ( $this->send_date !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = EmailQueuePeer::SEND_DATE;
			}
		} // if either are not null
	...
	public function setPriority($v)
	{
		...
		if ($this->priority !== $v) {
			$this->priority = $v;
			$this->modifiedColumns[] = EmailQueuePeer::PRIORITY;
		}
	...
	/**
	 * Set the value of [send_status] column.
	 * 
	...
	public function setSendStatus($v)
	{
		...
		if ($this->send_status !== $v || $v === 'pending') {
			$this->send_status = $v;
			$this->modifiedColumns[] = EmailQueuePeer::SEND_STATUS;
		}
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(EmailQueuePeer::SEND_STATUS))) {
				return false;
			}

			if ($this->send_status !== 'pending') {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->letter_id = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
			$this->request_date = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->send_date = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
			$this->priority = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
			$this->send_status = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
			$this->resetModified();
			...
			return $startcol + 7; // 7 = EmailQueuePeer::NUM_COLUMNS - EmailQueuePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[2] => $this->getLetterId(),
			$keys[3] => $this->getRequestDate(),
			$keys[4] => $this->getSendDate(),
			$keys[5] => $this->getPriority(),
			$keys[6] => $this->getSendStatus(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setLetterId($arr[$keys[2]]);
		if (array_key_exists($keys[3], $arr)) $this->setRequestDate($arr[$keys[3]]);
		if (array_key_exists($keys[4], $arr)) $this->setSendDate($arr[$keys[4]]);
		if (array_key_exists($keys[5], $arr)) $this->setPriority($arr[$keys[5]]);
		if (array_key_exists($keys[6], $arr)) $this->setSendStatus($arr[$keys[6]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(EmailQueuePeer::PERSON_ID)) $criteria->add(EmailQueuePeer::PERSON_ID, $this->person_id);
		if ($this->isColumnModified(EmailQueuePeer::LETTER_ID)) $criteria->add(EmailQueuePeer::LETTER_ID, $this->letter_id);
		if ($this->isColumnModified(EmailQueuePeer::REQUEST_DATE)) $criteria->add(EmailQueuePeer::REQUEST_DATE, $this->request_date);
		if ($this->isColumnModified(EmailQueuePeer::SEND_DATE)) $criteria->add(EmailQueuePeer::SEND_DATE, $this->send_date);
		if ($this->isColumnModified(EmailQueuePeer::PRIORITY)) $criteria->add(EmailQueuePeer::PRIORITY, $this->priority);
		if ($this->isColumnModified(EmailQueuePeer::SEND_STATUS)) $criteria->add(EmailQueuePeer::SEND_STATUS, $this->send_status);
	...
	public function getPerson(PropelPDO $con = null)
	{
		if ($this->aPerson === null && ($this->person_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aPerson->addEmailQueues($this);
			 */
		}
		return $this->aPerson;
	}
	...
	public function getEmailLetter(PropelPDO $con = null)
	{
		if ($this->aEmailLetter === null && ($this->letter_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aEmailLetter->addEmailQueues($this);
			 */
		}
