...
/**
 * Base class that represents a row from the 'event_wings' table.
 *
 * 
 *
 ...
 */
abstract class BaseEventWings extends BaseObject  implements Persistent {


  const PEER = 'EventWingsPeer';
	...
	/**
	 * Initializes internal state of BaseEventWings object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     EventWings The current object (for fluent API support)
	 */
	public function setEventId($v)
	{
		...
		if ($this->event_id !== $v) {
			$this->event_id = $v;
			$this->modifiedColumns[] = EventWingsPeer::EVENT_ID;
		}
	...
	public function setWingId($v)
	{
		...
		if ($this->wing_id !== $v) {
			$this->wing_id = $v;
			$this->modifiedColumns[] = EventWingsPeer::WING_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->wing_id = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
			$this->resetModified();
			...
			return $startcol + 2; // 2 = EventWingsPeer::NUM_COLUMNS - EventWingsPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating EventWings object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = EventWingsPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BaseEventWings:delete:pre') as $callable)
    {
      ...
      if ($ret)
      {
		...
		try {
			EventWingsPeer::doDelete($this, $con);
    ...
    foreach (sfMixer::getCallables('BaseEventWings:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseEventWings:save:pre') as $callable)
    {
      ...
      if (is_int($affectedRows))
      {
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BaseEventWings:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
    }

			EventWingsPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	{
		$pos = EventWingsPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[1], $arr)) $this->setWingId($arr[$keys[1]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(EventWingsPeer::EVENT_ID)) $criteria->add(EventWingsPeer::EVENT_ID, $this->event_id);
		if ($this->isColumnModified(EventWingsPeer::WING_ID)) $criteria->add(EventWingsPeer::WING_ID, $this->wing_id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(EventWingsPeer::EVENT_ID, $this->event_id);
		$criteria->add(EventWingsPeer::WING_ID, $this->wing_id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of EventWings (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     EventWings Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     EventWingsPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new EventWingsPeer();
		}
		return self::$peer;
	}
	...
	public function getEvent(PropelPDO $con = null)
	{
		if ($this->aEvent === null && ($this->event_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aEvent->addEventWingss($this);
			 */
		}
		return $this->aEvent;
	}
	...
	public function getWing(PropelPDO $con = null)
	{
		if ($this->aWing === null && ($this->wing_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aWing->addEventWingss($this);
			 */
		}
		return $this->aWing;
	}
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseEventWings:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseEventWings::%s', $method));
    }
