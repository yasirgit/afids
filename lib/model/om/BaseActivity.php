...
abstract class BaseActivity extends BaseObject  implements Persistent {
  ...
  const PEER = 'ActivityPeer';
	...
	public function setContent($v)
	{
		...
		if ($this->content !== $v) {
			$this->content = $v;
			$this->modifiedColumns[] = ActivityPeer::CONTENT;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = ActivityPeer::NUM_COLUMNS - ActivityPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ActivityPeer::CONTENT)) $criteria->add(ActivityPeer::CONTENT, $this->content);
