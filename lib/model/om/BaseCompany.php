...
abstract class BaseCompany extends BaseObject  implements Persistent {
  ...
  const PEER = 'CompanyPeer';
	...
	/**
	 * The value for the has_matching_program field.
	 * @var        int
	 */
	protected $has_matching_program;

	/**
	 * The value for the has_payroll_withholding_program field.
	 * @var        int
	 */
	protected $has_payroll_withholding_program;
	...
	/**
	 * Get the [has_matching_program] column value.
	 * 
	 * @return     int
	 */
	public function getHasMatchingProgram()
	{
		return $this->has_matching_program;
	}

	/**
	 * Get the [has_payroll_withholding_program] column value.
	 * 
	 * @return     int
	 */
	public function getHasPayrollWithholdingProgram()
	{
		return $this->has_payroll_withholding_program;
	}
	...
	/**
	 * Set the value of [has_matching_program] column.
	 * 
	 * @param      int $v new value
	 * @return     Company The current object (for fluent API support)
	 */
	public function setHasMatchingProgram($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->has_matching_program !== $v) {
			$this->has_matching_program = $v;
			$this->modifiedColumns[] = CompanyPeer::HAS_MATCHING_PROGRAM;
		}

		return $this;
	} // setHasMatchingProgram()

	/**
	 * Set the value of [has_payroll_withholding_program] column.
	 * 
	 * @param      int $v new value
	 * @return     Company The current object (for fluent API support)
	 */
	public function setHasPayrollWithholdingProgram($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->has_payroll_withholding_program !== $v) {
			$this->has_payroll_withholding_program = $v;
			$this->modifiedColumns[] = CompanyPeer::HAS_PAYROLL_WITHHOLDING_PROGRAM;
		}

		return $this;
	} // setHasPayrollWithholdingProgram()
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->has_matching_program = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
			$this->has_payroll_withholding_program = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
			$this->resetModified();
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 1:
				...
				break;
			case 2:
				return $this->getHasMatchingProgram();
				break;
			case 3:
				return $this->getHasPayrollWithholdingProgram();
				break;
			default:
				return null;
				break;
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getName(),
			$keys[2] => $this->getHasMatchingProgram(),
			$keys[3] => $this->getHasPayrollWithholdingProgram(),
		);
		return $result;
	}
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 1:
				...
				break;
			case 2:
				$this->setHasMatchingProgram($value);
				break;
			case 3:
				$this->setHasPayrollWithholdingProgram($value);
				break;
		} // switch()
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setHasMatchingProgram($arr[$keys[2]]);
		if (array_key_exists($keys[3], $arr)) $this->setHasPayrollWithholdingProgram($arr[$keys[3]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CompanyPeer::HAS_MATCHING_PROGRAM)) $criteria->add(CompanyPeer::HAS_MATCHING_PROGRAM, $this->has_matching_program);
		if ($this->isColumnModified(CompanyPeer::HAS_PAYROLL_WITHHOLDING_PROGRAM)) $criteria->add(CompanyPeer::HAS_PAYROLL_WITHHOLDING_PROGRAM, $this->has_payroll_withholding_program);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setHasMatchingProgram($this->has_matching_program);

		$copyObj->setHasPayrollWithholdingProgram($this->has_payroll_withholding_program);
	 ...
	 * related Donors from storage. If this Company is new, it will return
		...
		if ($this->collDonors === null) {
			if ($this->isNew()) {
			   $this->collDonors = array();
				...
				$criteria->add(DonorPeer::COMPANY_ID, $this->id);
