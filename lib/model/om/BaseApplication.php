...
abstract class BaseApplication extends BaseObject  implements Persistent {
  ...
  const PEER = 'ApplicationPeer';
	...
	/**
	 * The value for the vocation_class_id field.
	 * @var        int
	 */
	protected $vocation_class_id;
	...
	/**
	 * The value for the member_meetings field.
	 * @var        int
	 */
	protected $member_meetings;
	...
	/**
	 * The value for the executive_board field.
	 * @var        int
	 */
	protected $executive_board;
	...
	/**
	 * The value for the other_volunteer field.
	 * @var        string
	 */
	protected $other_volunteer;

	/**
	 * The value for the t_shirt_size field.
	 * @var        string
	 */
	protected $t_shirt_size;
	 ...
	 * @var        VocationClass
	 */
	protected $aVocationClass;

	/**
	 * @var        RefSource
	 */
	protected $aRefSource;
	...
	/**
	 * Get the [vocation_class_id] column value.
	 * 
	 * @return     int
	 */
	public function getVocationClassId()
	{
		return $this->vocation_class_id;
	}
	...
	/**
	 * Get the [member_meetings] column value.
	 * 
	 * @return     int
	 */
	public function getMemberMeetings()
	{
		return $this->member_meetings;
	}
	...
	/**
	 * Get the [executive_board] column value.
	 * 
	 * @return     int
	 */
	public function getExecutiveBoard()
	{
		return $this->executive_board;
	}
	...
	/**
	 * Get the [other_volunteer] column value.
	 * 
	 * @return     string
	 */
	public function getOtherVolunteer()
	{
		return $this->other_volunteer;
	}

	/**
	 * Get the [t_shirt_size] column value.
	 * 
	 * @return     string
	 */
	...
	public function setCcardNumber($v)
	{
		...
		if ($this->ccard_number !== $v) {
			$this->ccard_number = $v;
			$this->modifiedColumns[] = ApplicationPeer::CCARD_NUMBER;
		}
	...
	public function setCcardCode($v)
	{
		...
		if ($this->ccard_code !== $v) {
			$this->ccard_code = $v;
			$this->modifiedColumns[] = ApplicationPeer::CCARD_CODE;
		}
	...
	public function setCcardExpire($v)
	{
		...
		if ( $this->ccard_expire !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = ApplicationPeer::CCARD_EXPIRE;
			}
	...
	public function setMemberId($v)
	{
		...
		if ($this->member_id !== $v) {
			$this->member_id = $v;
			$this->modifiedColumns[] = ApplicationPeer::MEMBER_ID;
		}
	...
	public function setRenewal($v)
	{
		...
		if ($this->renewal !== $v) {
			$this->renewal = $v;
			$this->modifiedColumns[] = ApplicationPeer::RENEWAL;
		}
	...
	public function setDate($v)
	{
		...
		if ( $this->date !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = ApplicationPeer::DATE;
			}
		} // if either are not null
	...
	/**
	 * Set the value of [vocation_class_id] column.
	 * 
	 * @param      int $v new value
	 * @return     Application The current object (for fluent API support)
	 */
	public function setVocationClassId($v)
	{
		...
		if ($this->vocation_class_id !== $v) {
			$this->vocation_class_id = $v;
			$this->modifiedColumns[] = ApplicationPeer::VOCATION_CLASS_ID;
		}

		if ($this->aVocationClass !== null && $this->aVocationClass->getId() !== $v) {
			$this->aVocationClass = null;
		}
	...
	public function setCompany($v)
	{
		...
		if ($this->company !== $v) {
			$this->company = $v;
			$this->modifiedColumns[] = ApplicationPeer::COMPANY;
		}
	...
	public function setLicenseType($v)
	{
		...
		if ($this->license_type !== $v) {
			$this->license_type = $v;
			$this->modifiedColumns[] = ApplicationPeer::LICENSE_TYPE;
		}
	...
	public function setIfr($v)
	{
		...
		if ($this->ifr !== $v) {
			$this->ifr = $v;
			$this->modifiedColumns[] = ApplicationPeer::IFR;
		}
	...
	public function setMultiEngine($v)
	{
		...
		if ($this->multi_engine !== $v) {
			$this->multi_engine = $v;
			$this->modifiedColumns[] = ApplicationPeer::MULTI_ENGINE;
		}
	...
	public function setSeInstructor($v)
	{
		...
		if ($this->se_instructor !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::SE_INSTRUCTOR;
		}
	...
	public function setMeInstructor($v)
	{
		...
		if ($this->me_instructor !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::ME_INSTRUCTOR;
		}
	...
	public function setOtherRatings($v)
	{
		...
		if ($this->other_ratings !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::OTHER_RATINGS;
		}
	...
	public function setTotalHours($v)
	{
		...
		if ($this->total_hours !== $v) {
			$this->total_hours = $v;
			$this->modifiedColumns[] = ApplicationPeer::TOTAL_HOURS;
		}
	...
	/**
	 * Set the value of [fbo] column.
	 * 
	 * @param      string $v new value
	 * @return     Application The current object (for fluent API support)
	 */
	public function setFbo($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}
		...
		if ($this->fbo !== $v) {
			$this->fbo = $v;
			$this->modifiedColumns[] = ApplicationPeer::FBO;
		}
	...
	public function setMissionOrientation($v)
	{
		...
		if ($this->mission_orientation !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::MISSION_ORIENTATION;
		}
	...
	public function setMissionCoordination($v)
	{
		...
		if ($this->mission_coordination !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::MISSION_COORDINATION;
		}
	...
	public function setPilotRecruitment($v)
	{
		...
		if ($this->pilot_recruitment !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::PILOT_RECRUITMENT;
		}
	...
	public function setFundRaising($v)
	{
		...
		if ($this->fund_raising !== $v) {
			$this->fund_raising = $v;
			$this->modifiedColumns[] = ApplicationPeer::FUND_RAISING;
		}
	...
	public function setCelebrityContacts($v)
	{
		...
		if ($this->celebrity_contacts !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::CELEBRITY_CONTACTS;
		}
	...
	public function setHospitalOutreach($v)
	{
		...
		if ($this->hospital_outreach !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::HOSPITAL_OUTREACH;
		}
	...
	/**
	 * Set the value of [member_meetings] column.
	 * 
	 * @param      int $v new value
	 * @return     Application The current object (for fluent API support)
	 */
	public function setMemberMeetings($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->member_meetings !== $v) {
			$this->member_meetings = $v;
			$this->modifiedColumns[] = ApplicationPeer::MEMBER_MEETINGS;
		}
	...
	public function setMediaRelations($v)
	{
		...
		if ($this->media_relations !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::MEDIA_RELATIONS;
		}
	...
	public function setTelephoneWork($v)
	{
		...
		if ($this->telephone_work !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::TELEPHONE_WORK;
		}
	...
	public function setComputers($v)
	{
		...
		if ($this->computers !== $v) {
			$this->computers = $v;
			$this->modifiedColumns[] = ApplicationPeer::COMPUTERS;
		}
	...
	public function setClerical($v)
	{
		...
		if ($this->clerical !== $v) {
			$this->clerical = $v;
			$this->modifiedColumns[] = ApplicationPeer::CLERICAL;
		}
	...
	public function setPublicity($v)
	{
		...
		if ($this->publicity !== $v) {
			$this->publicity = $v;
			$this->modifiedColumns[] = ApplicationPeer::PUBLICITY;
		}
	...
	public function setWriting($v)
	{
		...
		if ($this->writing !== $v) {
			$this->writing = $v;
			$this->modifiedColumns[] = ApplicationPeer::WRITING;
		}
	...
	public function setSpeakersBureau($v)
	{
		...
		if ($this->speakers_bureau !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::SPEAKERS_BUREAU;
		}
	...
	/**
	 * Set the value of [executive_board] column.
	 * 
	 * @param      int $v new value
	 * @return     Application The current object (for fluent API support)
	 */
	public function setExecutiveBoard($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->executive_board !== $v) {
			$this->executive_board = $v;
			$this->modifiedColumns[] = ApplicationPeer::EXECUTIVE_BOARD;
		}
	...
	public function setWingTeam($v)
	{
		...
		if ($this->wing_team !== $v) {
			$this->wing_team = $v;
			$this->modifiedColumns[] = ApplicationPeer::WING_TEAM;
		}
	...
	public function setGraphicArts($v)
	{
		...
		if ($this->graphic_arts !== $v) {
			$this->graphic_arts = $v;
			$this->modifiedColumns[] = ApplicationPeer::GRAPHIC_ARTS;
		}
	...
	/**
	 * Set the value of [other_volunteer] column.
	 * 
	 * @param      string $v new value
	 * @return     Application The current object (for fluent API support)
	 */
	public function setOtherVolunteer($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->other_volunteer !== $v) {
			$this->other_volunteer = $v;
			$this->modifiedColumns[] = ApplicationPeer::OTHER_VOLUNTEER;
		}
	...
	/**
	 * Set the value of [t_shirt_size] column.
	 * 
	 * @param      string $v new value
	 * @return     Application The current object (for fluent API support)
	 */
	public function setTShirtSize($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->t_shirt_size !== $v) {
			$this->t_shirt_size = $v;
			$this->modifiedColumns[] = ApplicationPeer::T_SHIRT_SIZE;
		}
	...
	public function setDuesAmountPaid($v)
	{
		...
		if ($this->dues_amount_paid !== $v || $v === 0) {
			...
			$this->modifiedColumns[] = ApplicationPeer::DUES_AMOUNT_PAID;
		}
	...
	public function setMethodOfPayment($v)
	{
		...
		if ($this->method_of_payment !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::METHOD_OF_PAYMENT;
		}
	...
	public function setCheckNumber($v)
	{
		...
		if ($this->check_number !== $v) {
			$this->check_number = $v;
			$this->modifiedColumns[] = ApplicationPeer::CHECK_NUMBER;
		}
	...
	public function setDonationAmountPaid($v)
	{
		...
		if ($this->donation_amount_paid !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::DONATION_AMOUNT_PAID;
		}
	...
	public function setAddress1($v)
	{
		...
		if ($this->address1 !== $v) {
			$this->address1 = $v;
			$this->modifiedColumns[] = ApplicationPeer::ADDRESS1;
		}
	...
	public function setAddress2($v)
	{
		...
		if ($this->address2 !== $v) {
			$this->address2 = $v;
			$this->modifiedColumns[] = ApplicationPeer::ADDRESS2;
		}
	...
	public function setState($v)
	{
		...
		if ($this->state !== $v) {
			$this->state = $v;
			$this->modifiedColumns[] = ApplicationPeer::STATE;
		}
	...
	public function setZipcode($v)
	{
		...
		if ($this->zipcode !== $v) {
			$this->zipcode = $v;
			$this->modifiedColumns[] = ApplicationPeer::ZIPCODE;
		}
	...
	public function setDayPhone($v)
	{
		...
		if ($this->day_phone !== $v) {
			$this->day_phone = $v;
			$this->modifiedColumns[] = ApplicationPeer::DAY_PHONE;
		}
	...
	public function setDayComment($v)
	{
		...
		if ($this->day_comment !== $v) {
			$this->day_comment = $v;
			$this->modifiedColumns[] = ApplicationPeer::DAY_COMMENT;
		}
	...
	public function setEvePhone($v)
	{
		...
		if ($this->eve_phone !== $v) {
			$this->eve_phone = $v;
			$this->modifiedColumns[] = ApplicationPeer::EVE_PHONE;
		}
	...
	public function setEveComment($v)
	{
		...
		if ($this->eve_comment !== $v) {
			$this->eve_comment = $v;
			$this->modifiedColumns[] = ApplicationPeer::EVE_COMMENT;
		}
	...
	public function setMobilePhone($v)
	{
		...
		if ($this->mobile_phone !== $v) {
			$this->mobile_phone = $v;
			$this->modifiedColumns[] = ApplicationPeer::MOBILE_PHONE;
		}
	...
	public function setMobileComment($v)
	{
		...
		if ($this->mobile_comment !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::MOBILE_COMMENT;
		}
	...
	public function setPagerPhone($v)
	{
		...
		if ($this->pager_phone !== $v) {
			$this->pager_phone = $v;
			$this->modifiedColumns[] = ApplicationPeer::PAGER_PHONE;
		}
	...
	public function setPagerComment($v)
	{
		...
		if ($this->pager_comment !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::PAGER_COMMENT;
		}
	...
	public function setFaxPhone1($v)
	{
		...
		if ($this->fax_phone1 !== $v) {
			$this->fax_phone1 = $v;
			$this->modifiedColumns[] = ApplicationPeer::FAX_PHONE1;
		}
	...
	public function setFaxComment1($v)
	{
		...
		if ($this->fax_comment1 !== $v) {
			$this->fax_comment1 = $v;
			$this->modifiedColumns[] = ApplicationPeer::FAX_COMMENT1;
		}
	...
	public function setFaxPhone2($v)
	{
		...
		if ($this->fax_phone2 !== $v) {
			$this->fax_phone2 = $v;
			$this->modifiedColumns[] = ApplicationPeer::FAX_PHONE2;
		}
	...
	public function setFaxComment2($v)
	{
		...
		if ($this->fax_comment2 !== $v) {
			$this->fax_comment2 = $v;
			$this->modifiedColumns[] = ApplicationPeer::FAX_COMMENT2;
		}
	...
	public function setOtherPhone($v)
	{
		...
		if ($this->other_phone !== $v) {
			$this->other_phone = $v;
			$this->modifiedColumns[] = ApplicationPeer::OTHER_PHONE;
		}
	...
	public function setOtherComment($v)
	{
		...
		if ($this->other_comment !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::OTHER_COMMENT;
		}
	...
	public function setEmail($v)
	{
		...
		if ($this->email !== $v) {
			$this->email = $v;
			$this->modifiedColumns[] = ApplicationPeer::EMAIL;
		}
	...
	public function setSpouseFirstName($v)
	{
		...
		if ($this->spouse_first_name !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::SPOUSE_FIRST_NAME;
		}
	...
	public function setSpouseLastName($v)
	{
		...
		if ($this->spouse_last_name !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::SPOUSE_LAST_NAME;
		}
	...
	public function setApplicantPilot($v)
	{
		...
		if ($this->applicant_pilot !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::APPLICANT_PILOT;
		}
	...
	public function setLanguagesSpoken($v)
	{
		...
		if ($this->languages_spoken !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::LANGUAGES_SPOKEN;
		}
	...
	public function setHomeBase($v)
	{
		...
		if ($this->home_base !== $v) {
			$this->home_base = $v;
			$this->modifiedColumns[] = ApplicationPeer::HOME_BASE;
		}
	...
	public function setSecondaryHomeBases($v)
	{
		...
		if ($this->secondary_home_bases !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::SECONDARY_HOME_BASES;
		}
	...
	public function setAircraftPrimaryId($v)
	{
		...
		if ($this->aircraft_primary_id !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::AIRCRAFT_PRIMARY_ID;
		}
	...
	public function setAircraftPrimaryOwn($v)
	{
		...
		if ($this->aircraft_primary_own !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::AIRCRAFT_PRIMARY_OWN;
		}
	...
	public function setAircraftPrimaryIce($v)
	{
		...
		if ($this->aircraft_primary_ice !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::AIRCRAFT_PRIMARY_ICE;
		}
	...
	public function setAircraftPrimarySeats($v)
	{
		...
		if ($this->aircraft_primary_seats !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::AIRCRAFT_PRIMARY_SEATS;
		}
	...
	public function setAircraftPrimaryNNumber($v)
	{
		...
		if ($this->aircraft_primary_n_number !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::AIRCRAFT_PRIMARY_N_NUMBER;
		}
	...
	public function setAircraftSecondaryId($v)
	{
		...
		if ($this->aircraft_secondary_id !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::AIRCRAFT_SECONDARY_ID;
		}
	...
	public function setAircraftSecondaryOwn($v)
	{
		...
		if ($this->aircraft_secondary_own !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::AIRCRAFT_SECONDARY_OWN;
		}
	...
	public function setAircraftSecondaryIce($v)
	{
		...
		if ($this->aircraft_secondary_ice !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::AIRCRAFT_SECONDARY_ICE;
		}
	...
	public function setAircraftSecondarySeats($v)
	{
		...
		if ($this->aircraft_secondary_seats !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::AIRCRAFT_SECONDARY_SEATS;
		}
	...
	public function setAircraftSecondaryNNumber($v)
	{
		...
		if ($this->aircraft_secondary_n_number !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::AIRCRAFT_SECONDARY_N_NUMBER;
		}
	...
	public function setPilotCertificate($v)
	{
		...
		if ($this->pilot_certificate !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::PILOT_CERTIFICATE;
		}
	...
	public function setMedicalClass($v)
	{
		...
		if ($this->medical_class !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::MEDICAL_CLASS;
		}
	...
	public function setIfrHours($v)
	{
		...
		if ($this->ifr_hours !== $v) {
			$this->ifr_hours = $v;
			$this->modifiedColumns[] = ApplicationPeer::IFR_HOURS;
		}
	...
	public function setMultiHours($v)
	{
		...
		if ($this->multi_hours !== $v) {
			$this->multi_hours = $v;
			$this->modifiedColumns[] = ApplicationPeer::MULTI_HOURS;
		}
	...
	public function setOtherHours($v)
	{
		...
		if ($this->other_hours !== $v) {
			$this->other_hours = $v;
			$this->modifiedColumns[] = ApplicationPeer::OTHER_HOURS;
		}
	...
	public function setWeight($v)
	{
		...
		if ($this->weight !== $v) {
			$this->weight = $v;
			$this->modifiedColumns[] = ApplicationPeer::WEIGHT;
		}
	...
	public function setAvailabilityWeekdays($v)
	{
		...
		if ($this->availability_weekdays !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::AVAILABILITY_WEEKDAYS;
		}
	...
	public function setAvailabilityWeeknights($v)
	{
		...
		if ($this->availability_weeknights !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::AVAILABILITY_WEEKNIGHTS;
		}
	...
	public function setAvailabilityWeekends($v)
	{
		...
		if ($this->availability_weekends !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::AVAILABILITY_WEEKENDS;
		}
	...
	public function setAvailabilityNotice($v)
	{
		...
		if ($this->availability_notice !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::AVAILABILITY_NOTICE;
		}
	...
	public function setAvailabilityLastMinute($v)
	{
		...
		if ($this->availability_last_minute !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::AVAILABILITY_LAST_MINUTE;
		}
	...
	public function setAvailabilityCopilot($v)
	{
		...
		if ($this->availability_copilot !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::AVAILABILITY_COPILOT;
		}
	...
	public function setAffirmationAgreed($v)
	{
		...
		if ($this->affirmation_agreed !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::AFFIRMATION_AGREED;
		}
	...
	public function setInsuranceAgreed($v)
	{
		...
		if ($this->insurance_agreed !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::INSURANCE_AGREED;
		}
	...
	public function setVolunteerInterest($v)
	{
		...
		if ($this->volunteer_interest !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::VOLUNTEER_INTEREST;
		}
	...
	public function setCompanyPosition($v)
	{
		...
		if ($this->company_position !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::COMPANY_POSITION;
		}
	...
	public function setCompanyMatchFunds($v)
	{
		...
		if ($this->company_match_funds !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::COMPANY_MATCH_FUNDS;
		}
	...
	public function setCompanyBusinessCategoryId($v)
	{
		...
		if ($this->company_business_category_id !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::COMPANY_BUSINESS_CATEGORY_ID;
		}
	...
	public function setReferralSource($v)
	{
		...
		if ($this->referral_source !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::REFERRAL_SOURCE;
		}

		if ($this->aRefSource !== null && $this->aRefSource->getId() !== $v) {
			$this->aRefSource = null;
		}
	...
	public function setPremiumChoice($v)
	{
		...
		if ($this->premium_choice !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::PREMIUM_CHOICE;
		}
	...
	public function setPremiumSize($v)
	{
		...
		if ($this->premium_size !== $v) {
			$this->premium_size = $v;
			$this->modifiedColumns[] = ApplicationPeer::PREMIUM_SIZE;
		}
	...
	public function setCcardApprovalNumber($v)
	{
		...
		if ($this->ccard_approval_number !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::CCARD_APPROVAL_NUMBER;
		}
	...
	public function setCcardErrorCode($v)
	{
		...
		if ($this->ccard_error_code !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::CCARD_ERROR_CODE;
		}
	...
	public function setCcardAvsResult($v)
	{
		...
		if ($this->ccard_avs_result !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::CCARD_AVS_RESULT;
		}
	...
	public function setProcessedDate($v)
	{
		...
		if ( $this->processed_date !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = ApplicationPeer::PROCESSED_DATE;
			}
		} // if either are not null
	...
	public function setEventPlanning($v)
	{
		...
		if ($this->event_planning !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::EVENT_PLANNING;
		}
	...
	public function setWebInternet($v)
	{
		...
		if ($this->web_internet !== $v) {
			$this->web_internet = $v;
			$this->modifiedColumns[] = ApplicationPeer::WEB_INTERNET;
		}
	...
	public function setFoundationContacts($v)
	{
		...
		if ($this->foundation_contacts !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::FOUNDATION_CONTACTS;
		}
	...
	public function setAviationContacts($v)
	{
		...
		if ($this->aviation_contacts !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::AVIATION_CONTACTS;
		}
	...
	public function setPrinting($v)
	{
		...
		if ($this->printing !== $v) {
			$this->printing = $v;
			$this->modifiedColumns[] = ApplicationPeer::PRINTING;
		}
	...
	public function setMemberAopa($v)
	{
		...
		if ($this->member_aopa !== $v) {
			$this->member_aopa = $v;
			$this->modifiedColumns[] = ApplicationPeer::MEMBER_AOPA;
		}
	...
	public function setMemberKiwanis($v)
	{
		...
		if ($this->member_kiwanis !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::MEMBER_KIWANIS;
		}
	...
	public function setMemberRotary($v)
	{
		...
		if ($this->member_rotary !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::MEMBER_ROTARY;
		}
	...
	public function setMemberLions($v)
	{
		...
		if ($this->member_lions !== $v) {
			$this->member_lions = $v;
			$this->modifiedColumns[] = ApplicationPeer::MEMBER_LIONS;
		}
	...
	public function setNovapointeId($v)
	{
		...
		if ($this->novapointe_id !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::NOVAPOINTE_ID;
		}
	...
	public function setPremiumShipDate($v)
	{
		...
		if ( $this->premium_ship_date !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = ApplicationPeer::PREMIUM_SHIP_DATE;
			}
		} // if either are not null
	...
	public function setPremiumShipMethod($v)
	{
		...
		if ($this->premium_ship_method !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::PREMIUM_SHIP_METHOD;
		}
	...
	public function setPremiumShipCost($v)
	{
		...
		if ($this->premium_ship_cost !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::PREMIUM_SHIP_COST;
		}
	...
	public function setPremiumShipTrackingNumber($v)
	{
		...
		if ($this->premium_ship_tracking_number !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::PREMIUM_SHIP_TRACKING_NUMBER;
		}
	...
	public function setSpousePilot($v)
	{
		...
		if ($this->spouse_pilot !== $v) {
			$this->spouse_pilot = $v;
			$this->modifiedColumns[] = ApplicationPeer::SPOUSE_PILOT;
		}
	...
	public function setApplicantCopilot($v)
	{
		...
		if ($this->applicant_copilot !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::APPLICANT_COPILOT;
		}
	...
	public function setPagerEmail($v)
	{
		...
		if ($this->pager_email !== $v) {
			$this->pager_email = $v;
			$this->modifiedColumns[] = ApplicationPeer::PAGER_EMAIL;
		}
	...
	public function setMember99s($v)
	{
		...
		if ($this->member_99s !== $v) {
			$this->member_99s = $v;
			$this->modifiedColumns[] = ApplicationPeer::MEMBER_99S;
		}
	...
	public function setMemberWia($v)
	{
		...
		if ($this->member_wia !== $v) {
			$this->member_wia = $v;
			$this->modifiedColumns[] = ApplicationPeer::MEMBER_WIA;
		}
	...
	public function setMissionEmailOptin($v)
	{
		...
		if ($this->mission_email_optin !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::MISSION_EMAIL_OPTIN;
		}
	...
	public function setHseatsInterest($v)
	{
		...
		if ($this->hseats_interest !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::HSEATS_INTEREST;
		}
	...
	public function setMasterApplicationId($v)
	{
		...
		if ($this->master_application_id !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::MASTER_APPLICATION_ID;
		}
	...
	public function setMasterMemberId($v)
	{
		...
		if ($this->master_member_id !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::MASTER_MEMBER_ID;
		}
	...
	public function setReferralSourceOther($v)
	{
		...
		if ($this->referral_source_other !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::REFERRAL_SOURCE_OTHER;
		}
	...
	public function setSecondaryEmail($v)
	{
		...
		if ($this->secondary_email !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::SECONDARY_EMAIL;
		}
	...
	public function setPaymentTransactionId($v)
	{
		...
		if ($this->payment_transaction_id !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::PAYMENT_TRANSACTION_ID;
		}
	...
	public function setAircraftThirdIce($v)
	{
		...
		if ($this->aircraft_third_ice !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::AIRCRAFT_THIRD_ICE;
		}
	...
	public function setAircraftThirdId($v)
	{
		...
		if ($this->aircraft_third_id !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::AIRCRAFT_THIRD_ID;
		}
	...
	public function setAircraftThirdNNumber($v)
	{
		...
		if ($this->aircraft_third_n_number !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::AIRCRAFT_THIRD_N_NUMBER;
		}
	...
	public function setAircraftThirdOwn($v)
	{
		...
		if ($this->aircraft_third_own !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::AIRCRAFT_THIRD_OWN;
		}
	...
	public function setAircraftThirdSeats($v)
	{
		...
		if ($this->aircraft_third_seats !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::AIRCRAFT_THIRD_SEATS;
		}
	...
	public function setDriversLicenseNumber($v)
	{
		...
		if ($this->drivers_license_number !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::DRIVERS_LICENSE_NUMBER;
		}
	...
	public function setDriversLicenseState($v)
	{
		...
		if ($this->drivers_license_state !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::DRIVERS_LICENSE_STATE;
		}
	...
	public function setEmergencyContactName($v)
	{
		...
		if ($this->emergency_contact_name !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::EMERGENCY_CONTACT_NAME;
		}
	...
	public function setEmergencyContactPhone($v)
	{
		...
		if ($this->emergency_contact_phone !== $v) {
			...
			$this->modifiedColumns[] = ApplicationPeer::EMERGENCY_CONTACT_PHONE;
		}
	...
	public function setCountry($v)
	{
		...
		if ($this->country !== $v) {
			$this->country = $v;
			$this->modifiedColumns[] = ApplicationPeer::COUNTRY;
		}
	...
	public function setMiddleName($v)
	{
		...
		if ($this->middle_name !== $v) {
			$this->middle_name = $v;
			$this->modifiedColumns[] = ApplicationPeer::MIDDLE_NAME;
		}
	...
	public function setSuffix($v)
	{
		...
		if ($this->suffix !== $v) {
			$this->suffix = $v;
			$this->modifiedColumns[] = ApplicationPeer::SUFFIX;
		}
	...
	public function setNickname($v)
	{
		...
		if ($this->nickname !== $v) {
			$this->nickname = $v;
			$this->modifiedColumns[] = ApplicationPeer::NICKNAME;
		}
	...
	public function setVeteran($v)
	{
		...
		if ($this->veteran !== $v) {
			$this->veteran = $v;
			$this->modifiedColumns[] = ApplicationPeer::VETERAN;
		}
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(ApplicationPeer::DUES_AMOUNT_PAID))) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->ccard_number = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			$this->ccard_code = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			$this->ccard_expire = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->member_id = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
			$this->renewal = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
			$this->date = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
			$this->vocation_class_id = ($row[$startcol + 7] !== null) ? (int) $row[$startcol + 7] : null;
			$this->company = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
			$this->license_type = ($row[$startcol + 9] !== null) ? (string) $row[$startcol + 9] : null;
			$this->ifr = ($row[$startcol + 10] !== null) ? (int) $row[$startcol + 10] : null;
			$this->multi_engine = ($row[$startcol + 11] !== null) ? (int) $row[$startcol + 11] : null;
			$this->se_instructor = ($row[$startcol + 12] !== null) ? (string) $row[$startcol + 12] : null;
			$this->me_instructor = ($row[$startcol + 13] !== null) ? (string) $row[$startcol + 13] : null;
			$this->other_ratings = ($row[$startcol + 14] !== null) ? (string) $row[$startcol + 14] : null;
			$this->total_hours = ($row[$startcol + 15] !== null) ? (int) $row[$startcol + 15] : null;
			$this->fbo = ($row[$startcol + 16] !== null) ? (string) $row[$startcol + 16] : null;
			$this->mission_orientation = ($row[$startcol + 17] !== null) ? (int) $row[$startcol + 17] : null;
			$this->mission_coordination = ($row[$startcol + 18] !== null) ? (int) $row[$startcol + 18] : null;
			$this->pilot_recruitment = ($row[$startcol + 19] !== null) ? (int) $row[$startcol + 19] : null;
			$this->fund_raising = ($row[$startcol + 20] !== null) ? (int) $row[$startcol + 20] : null;
			$this->celebrity_contacts = ($row[$startcol + 21] !== null) ? (int) $row[$startcol + 21] : null;
			$this->hospital_outreach = ($row[$startcol + 22] !== null) ? (int) $row[$startcol + 22] : null;
			$this->member_meetings = ($row[$startcol + 23] !== null) ? (int) $row[$startcol + 23] : null;
			$this->media_relations = ($row[$startcol + 24] !== null) ? (int) $row[$startcol + 24] : null;
			$this->telephone_work = ($row[$startcol + 25] !== null) ? (int) $row[$startcol + 25] : null;
			$this->computers = ($row[$startcol + 26] !== null) ? (int) $row[$startcol + 26] : null;
			$this->clerical = ($row[$startcol + 27] !== null) ? (int) $row[$startcol + 27] : null;
			$this->publicity = ($row[$startcol + 28] !== null) ? (int) $row[$startcol + 28] : null;
			$this->writing = ($row[$startcol + 29] !== null) ? (int) $row[$startcol + 29] : null;
			$this->speakers_bureau = ($row[$startcol + 30] !== null) ? (int) $row[$startcol + 30] : null;
			$this->executive_board = ($row[$startcol + 31] !== null) ? (int) $row[$startcol + 31] : null;
			$this->wing_team = ($row[$startcol + 32] !== null) ? (int) $row[$startcol + 32] : null;
			$this->graphic_arts = ($row[$startcol + 33] !== null) ? (int) $row[$startcol + 33] : null;
			$this->other_volunteer = ($row[$startcol + 34] !== null) ? (string) $row[$startcol + 34] : null;
			$this->t_shirt_size = ($row[$startcol + 35] !== null) ? (string) $row[$startcol + 35] : null;
			$this->dues_amount_paid = ($row[$startcol + 36] !== null) ? (double) $row[$startcol + 36] : null;
			$this->method_of_payment = ($row[$startcol + 37] !== null) ? (string) $row[$startcol + 37] : null;
			$this->check_number = ($row[$startcol + 38] !== null) ? (int) $row[$startcol + 38] : null;
			$this->donation_amount_paid = ($row[$startcol + 39] !== null) ? (double) $row[$startcol + 39] : null;
			$this->title = ($row[$startcol + 40] !== null) ? (string) $row[$startcol + 40] : null;
			$this->first_name = ($row[$startcol + 41] !== null) ? (string) $row[$startcol + 41] : null;
			$this->last_name = ($row[$startcol + 42] !== null) ? (string) $row[$startcol + 42] : null;
			$this->address1 = ($row[$startcol + 43] !== null) ? (string) $row[$startcol + 43] : null;
			$this->address2 = ($row[$startcol + 44] !== null) ? (string) $row[$startcol + 44] : null;
			$this->city = ($row[$startcol + 45] !== null) ? (string) $row[$startcol + 45] : null;
			$this->state = ($row[$startcol + 46] !== null) ? (string) $row[$startcol + 46] : null;
			$this->zipcode = ($row[$startcol + 47] !== null) ? (string) $row[$startcol + 47] : null;
			$this->day_phone = ($row[$startcol + 48] !== null) ? (string) $row[$startcol + 48] : null;
			$this->day_comment = ($row[$startcol + 49] !== null) ? (string) $row[$startcol + 49] : null;
			$this->eve_phone = ($row[$startcol + 50] !== null) ? (string) $row[$startcol + 50] : null;
			$this->eve_comment = ($row[$startcol + 51] !== null) ? (string) $row[$startcol + 51] : null;
			$this->mobile_phone = ($row[$startcol + 52] !== null) ? (string) $row[$startcol + 52] : null;
			$this->mobile_comment = ($row[$startcol + 53] !== null) ? (string) $row[$startcol + 53] : null;
			$this->pager_phone = ($row[$startcol + 54] !== null) ? (string) $row[$startcol + 54] : null;
			$this->pager_comment = ($row[$startcol + 55] !== null) ? (string) $row[$startcol + 55] : null;
			$this->fax_phone1 = ($row[$startcol + 56] !== null) ? (string) $row[$startcol + 56] : null;
			$this->fax_comment1 = ($row[$startcol + 57] !== null) ? (string) $row[$startcol + 57] : null;
			$this->fax_phone2 = ($row[$startcol + 58] !== null) ? (string) $row[$startcol + 58] : null;
			$this->fax_comment2 = ($row[$startcol + 59] !== null) ? (string) $row[$startcol + 59] : null;
			$this->other_phone = ($row[$startcol + 60] !== null) ? (string) $row[$startcol + 60] : null;
			$this->other_comment = ($row[$startcol + 61] !== null) ? (string) $row[$startcol + 61] : null;
			$this->email = ($row[$startcol + 62] !== null) ? (string) $row[$startcol + 62] : null;
			$this->spouse_first_name = ($row[$startcol + 63] !== null) ? (string) $row[$startcol + 63] : null;
			$this->spouse_last_name = ($row[$startcol + 64] !== null) ? (string) $row[$startcol + 64] : null;
			$this->applicant_pilot = ($row[$startcol + 65] !== null) ? (int) $row[$startcol + 65] : null;
			$this->languages_spoken = ($row[$startcol + 66] !== null) ? (string) $row[$startcol + 66] : null;
			$this->home_base = ($row[$startcol + 67] !== null) ? (string) $row[$startcol + 67] : null;
			$this->secondary_home_bases = ($row[$startcol + 68] !== null) ? (string) $row[$startcol + 68] : null;
			$this->aircraft_primary_id = ($row[$startcol + 69] !== null) ? (int) $row[$startcol + 69] : null;
			$this->aircraft_primary_own = ($row[$startcol + 70] !== null) ? (int) $row[$startcol + 70] : null;
			$this->aircraft_primary_ice = ($row[$startcol + 71] !== null) ? (int) $row[$startcol + 71] : null;
			$this->aircraft_primary_seats = ($row[$startcol + 72] !== null) ? (int) $row[$startcol + 72] : null;
			$this->aircraft_primary_n_number = ($row[$startcol + 73] !== null) ? (string) $row[$startcol + 73] : null;
			$this->aircraft_secondary_id = ($row[$startcol + 74] !== null) ? (int) $row[$startcol + 74] : null;
			$this->aircraft_secondary_own = ($row[$startcol + 75] !== null) ? (int) $row[$startcol + 75] : null;
			$this->aircraft_secondary_ice = ($row[$startcol + 76] !== null) ? (int) $row[$startcol + 76] : null;
			$this->aircraft_secondary_seats = ($row[$startcol + 77] !== null) ? (int) $row[$startcol + 77] : null;
			$this->aircraft_secondary_n_number = ($row[$startcol + 78] !== null) ? (string) $row[$startcol + 78] : null;
			$this->pilot_certificate = ($row[$startcol + 79] !== null) ? (string) $row[$startcol + 79] : null;
			$this->medical_class = ($row[$startcol + 80] !== null) ? (int) $row[$startcol + 80] : null;
			$this->ifr_hours = ($row[$startcol + 81] !== null) ? (int) $row[$startcol + 81] : null;
			$this->multi_hours = ($row[$startcol + 82] !== null) ? (int) $row[$startcol + 82] : null;
			$this->other_hours = ($row[$startcol + 83] !== null) ? (int) $row[$startcol + 83] : null;
			$this->date_of_birth = ($row[$startcol + 84] !== null) ? (string) $row[$startcol + 84] : null;
			$this->height = ($row[$startcol + 85] !== null) ? (int) $row[$startcol + 85] : null;
			$this->weight = ($row[$startcol + 86] !== null) ? (int) $row[$startcol + 86] : null;
			$this->availability_weekdays = ($row[$startcol + 87] !== null) ? (int) $row[$startcol + 87] : null;
			$this->availability_weeknights = ($row[$startcol + 88] !== null) ? (int) $row[$startcol + 88] : null;
			$this->availability_weekends = ($row[$startcol + 89] !== null) ? (int) $row[$startcol + 89] : null;
			$this->availability_notice = ($row[$startcol + 90] !== null) ? (int) $row[$startcol + 90] : null;
			$this->availability_last_minute = ($row[$startcol + 91] !== null) ? (int) $row[$startcol + 91] : null;
			$this->availability_copilot = ($row[$startcol + 92] !== null) ? (int) $row[$startcol + 92] : null;
			$this->affirmation_agreed = ($row[$startcol + 93] !== null) ? (int) $row[$startcol + 93] : null;
			$this->insurance_agreed = ($row[$startcol + 94] !== null) ? (int) $row[$startcol + 94] : null;
			$this->volunteer_interest = ($row[$startcol + 95] !== null) ? (string) $row[$startcol + 95] : null;
			$this->company_position = ($row[$startcol + 96] !== null) ? (string) $row[$startcol + 96] : null;
			$this->company_match_funds = ($row[$startcol + 97] !== null) ? (int) $row[$startcol + 97] : null;
			$this->company_business_category_id = ($row[$startcol + 98] !== null) ? (int) $row[$startcol + 98] : null;
			$this->referral_source = ($row[$startcol + 99] !== null) ? (int) $row[$startcol + 99] : null;
			$this->premium_choice = ($row[$startcol + 100] !== null) ? (int) $row[$startcol + 100] : null;
			$this->premium_size = ($row[$startcol + 101] !== null) ? (int) $row[$startcol + 101] : null;
			$this->ccard_approval_number = ($row[$startcol + 102] !== null) ? (string) $row[$startcol + 102] : null;
			$this->ccard_error_code = ($row[$startcol + 103] !== null) ? (string) $row[$startcol + 103] : null;
			$this->ccard_avs_result = ($row[$startcol + 104] !== null) ? (string) $row[$startcol + 104] : null;
			$this->processed_date = ($row[$startcol + 105] !== null) ? (string) $row[$startcol + 105] : null;
			$this->event_planning = ($row[$startcol + 106] !== null) ? (int) $row[$startcol + 106] : null;
			$this->web_internet = ($row[$startcol + 107] !== null) ? (int) $row[$startcol + 107] : null;
			$this->foundation_contacts = ($row[$startcol + 108] !== null) ? (int) $row[$startcol + 108] : null;
			$this->aviation_contacts = ($row[$startcol + 109] !== null) ? (int) $row[$startcol + 109] : null;
			$this->printing = ($row[$startcol + 110] !== null) ? (int) $row[$startcol + 110] : null;
			$this->member_aopa = ($row[$startcol + 111] !== null) ? (int) $row[$startcol + 111] : null;
			$this->member_kiwanis = ($row[$startcol + 112] !== null) ? (int) $row[$startcol + 112] : null;
			$this->member_rotary = ($row[$startcol + 113] !== null) ? (int) $row[$startcol + 113] : null;
			$this->member_lions = ($row[$startcol + 114] !== null) ? (int) $row[$startcol + 114] : null;
			$this->novapointe_id = ($row[$startcol + 115] !== null) ? (int) $row[$startcol + 115] : null;
			$this->premium_ship_date = ($row[$startcol + 116] !== null) ? (string) $row[$startcol + 116] : null;
			$this->premium_ship_method = ($row[$startcol + 117] !== null) ? (string) $row[$startcol + 117] : null;
			$this->premium_ship_cost = ($row[$startcol + 118] !== null) ? (int) $row[$startcol + 118] : null;
			$this->premium_ship_tracking_number = ($row[$startcol + 119] !== null) ? (string) $row[$startcol + 119] : null;
			$this->spouse_pilot = ($row[$startcol + 120] !== null) ? (int) $row[$startcol + 120] : null;
			$this->applicant_copilot = ($row[$startcol + 121] !== null) ? (int) $row[$startcol + 121] : null;
			$this->pager_email = ($row[$startcol + 122] !== null) ? (string) $row[$startcol + 122] : null;
			$this->member_99s = ($row[$startcol + 123] !== null) ? (int) $row[$startcol + 123] : null;
			$this->member_wia = ($row[$startcol + 124] !== null) ? (int) $row[$startcol + 124] : null;
			$this->mission_email_optin = ($row[$startcol + 125] !== null) ? (int) $row[$startcol + 125] : null;
			$this->hseats_interest = ($row[$startcol + 126] !== null) ? (int) $row[$startcol + 126] : null;
			$this->master_application_id = ($row[$startcol + 127] !== null) ? (int) $row[$startcol + 127] : null;
			$this->master_member_id = ($row[$startcol + 128] !== null) ? (int) $row[$startcol + 128] : null;
			$this->referral_source_other = ($row[$startcol + 129] !== null) ? (string) $row[$startcol + 129] : null;
			$this->secondary_email = ($row[$startcol + 130] !== null) ? (string) $row[$startcol + 130] : null;
			$this->payment_transaction_id = ($row[$startcol + 131] !== null) ? (int) $row[$startcol + 131] : null;
			$this->aircraft_third_ice = ($row[$startcol + 132] !== null) ? (int) $row[$startcol + 132] : null;
			$this->aircraft_third_id = ($row[$startcol + 133] !== null) ? (int) $row[$startcol + 133] : null;
			$this->aircraft_third_n_number = ($row[$startcol + 134] !== null) ? (string) $row[$startcol + 134] : null;
			$this->aircraft_third_own = ($row[$startcol + 135] !== null) ? (int) $row[$startcol + 135] : null;
			$this->aircraft_third_seats = ($row[$startcol + 136] !== null) ? (int) $row[$startcol + 136] : null;
			$this->drivers_license_number = ($row[$startcol + 137] !== null) ? (string) $row[$startcol + 137] : null;
			$this->drivers_license_state = ($row[$startcol + 138] !== null) ? (string) $row[$startcol + 138] : null;
			$this->emergency_contact_name = ($row[$startcol + 139] !== null) ? (string) $row[$startcol + 139] : null;
			$this->emergency_contact_phone = ($row[$startcol + 140] !== null) ? (string) $row[$startcol + 140] : null;
			$this->country = ($row[$startcol + 141] !== null) ? (string) $row[$startcol + 141] : null;
			$this->middle_name = ($row[$startcol + 142] !== null) ? (string) $row[$startcol + 142] : null;
			$this->suffix = ($row[$startcol + 143] !== null) ? (string) $row[$startcol + 143] : null;
			$this->nickname = ($row[$startcol + 144] !== null) ? (string) $row[$startcol + 144] : null;
			$this->veteran = ($row[$startcol + 145] !== null) ? (int) $row[$startcol + 145] : null;
			$this->gender = ($row[$startcol + 146] !== null) ? (string) $row[$startcol + 146] : null;
			$this->resetModified();
			...
			return $startcol + 147; // 147 = ApplicationPeer::NUM_COLUMNS - ApplicationPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function ensureConsistency()
	{
		...
		if ($this->aVocationClass !== null && $this->vocation_class_id !== $this->aVocationClass->getId()) {
			$this->aVocationClass = null;
		}
		if ($this->aRefSource !== null && $this->referral_source !== $this->aRefSource->getId()) {
			$this->aRefSource = null;
		}
	} // ensureConsistency
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->aVocationClass !== null) {
				if ($this->aVocationClass->isModified() || $this->aVocationClass->isNew()) {
					$affectedRows += $this->aVocationClass->save($con);
				}
				$this->setVocationClass($this->aVocationClass);
			}

			if ($this->aRefSource !== null) {
				if ($this->aRefSource->isModified() || $this->aRefSource->isNew()) {
					$affectedRows += $this->aRefSource->save($con);
				}
				$this->setRefSource($this->aRefSource);
			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if ($this->aVocationClass !== null) {
				if (!$this->aVocationClass->validate($columns)) {
					$failureMap = array_merge($failureMap, $this->aVocationClass->getValidationFailures());
				}
			}
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 33:
				...
				break;
			case 34:
				return $this->getOtherVolunteer();
				break;
			case 35:
				return $this->getTShirtSize();
				break;
			case 36:
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getCcardNumber(),
			$keys[2] => $this->getCcardCode(),
			$keys[3] => $this->getCcardExpire(),
			$keys[4] => $this->getMemberId(),
			$keys[5] => $this->getRenewal(),
			$keys[6] => $this->getDate(),
			$keys[7] => $this->getVocationClassId(),
			$keys[8] => $this->getCompany(),
			$keys[9] => $this->getLicenseType(),
			$keys[10] => $this->getIfr(),
			$keys[11] => $this->getMultiEngine(),
			$keys[12] => $this->getSeInstructor(),
			$keys[13] => $this->getMeInstructor(),
			$keys[14] => $this->getOtherRatings(),
			$keys[15] => $this->getTotalHours(),
			$keys[16] => $this->getFbo(),
			$keys[17] => $this->getMissionOrientation(),
			$keys[18] => $this->getMissionCoordination(),
			$keys[19] => $this->getPilotRecruitment(),
			$keys[20] => $this->getFundRaising(),
			$keys[21] => $this->getCelebrityContacts(),
			$keys[22] => $this->getHospitalOutreach(),
			$keys[23] => $this->getMemberMeetings(),
			$keys[24] => $this->getMediaRelations(),
			$keys[25] => $this->getTelephoneWork(),
			$keys[26] => $this->getComputers(),
			$keys[27] => $this->getClerical(),
			$keys[28] => $this->getPublicity(),
			$keys[29] => $this->getWriting(),
			$keys[30] => $this->getSpeakersBureau(),
			$keys[31] => $this->getExecutiveBoard(),
			$keys[32] => $this->getWingTeam(),
			$keys[33] => $this->getGraphicArts(),
			$keys[34] => $this->getOtherVolunteer(),
			$keys[35] => $this->getTShirtSize(),
			$keys[36] => $this->getDuesAmountPaid(),
			$keys[37] => $this->getMethodOfPayment(),
			$keys[38] => $this->getCheckNumber(),
			$keys[39] => $this->getDonationAmountPaid(),
			$keys[40] => $this->getTitle(),
			$keys[41] => $this->getFirstName(),
			$keys[42] => $this->getLastName(),
			$keys[43] => $this->getAddress1(),
			$keys[44] => $this->getAddress2(),
			$keys[45] => $this->getCity(),
			$keys[46] => $this->getState(),
			$keys[47] => $this->getZipcode(),
			$keys[48] => $this->getDayPhone(),
			$keys[49] => $this->getDayComment(),
			$keys[50] => $this->getEvePhone(),
			$keys[51] => $this->getEveComment(),
			$keys[52] => $this->getMobilePhone(),
			$keys[53] => $this->getMobileComment(),
			$keys[54] => $this->getPagerPhone(),
			$keys[55] => $this->getPagerComment(),
			$keys[56] => $this->getFaxPhone1(),
			$keys[57] => $this->getFaxComment1(),
			$keys[58] => $this->getFaxPhone2(),
			$keys[59] => $this->getFaxComment2(),
			$keys[60] => $this->getOtherPhone(),
			$keys[61] => $this->getOtherComment(),
			$keys[62] => $this->getEmail(),
			$keys[63] => $this->getSpouseFirstName(),
			$keys[64] => $this->getSpouseLastName(),
			$keys[65] => $this->getApplicantPilot(),
			$keys[66] => $this->getLanguagesSpoken(),
			$keys[67] => $this->getHomeBase(),
			$keys[68] => $this->getSecondaryHomeBases(),
			$keys[69] => $this->getAircraftPrimaryId(),
			$keys[70] => $this->getAircraftPrimaryOwn(),
			$keys[71] => $this->getAircraftPrimaryIce(),
			$keys[72] => $this->getAircraftPrimarySeats(),
			$keys[73] => $this->getAircraftPrimaryNNumber(),
			$keys[74] => $this->getAircraftSecondaryId(),
			$keys[75] => $this->getAircraftSecondaryOwn(),
			$keys[76] => $this->getAircraftSecondaryIce(),
			$keys[77] => $this->getAircraftSecondarySeats(),
			$keys[78] => $this->getAircraftSecondaryNNumber(),
			$keys[79] => $this->getPilotCertificate(),
			$keys[80] => $this->getMedicalClass(),
			$keys[81] => $this->getIfrHours(),
			$keys[82] => $this->getMultiHours(),
			$keys[83] => $this->getOtherHours(),
			$keys[84] => $this->getDateOfBirth(),
			$keys[85] => $this->getHeight(),
			$keys[86] => $this->getWeight(),
			$keys[87] => $this->getAvailabilityWeekdays(),
			$keys[88] => $this->getAvailabilityWeeknights(),
			$keys[89] => $this->getAvailabilityWeekends(),
			$keys[90] => $this->getAvailabilityNotice(),
			$keys[91] => $this->getAvailabilityLastMinute(),
			$keys[92] => $this->getAvailabilityCopilot(),
			$keys[93] => $this->getAffirmationAgreed(),
			$keys[94] => $this->getInsuranceAgreed(),
			$keys[95] => $this->getVolunteerInterest(),
			$keys[96] => $this->getCompanyPosition(),
			$keys[97] => $this->getCompanyMatchFunds(),
			$keys[98] => $this->getCompanyBusinessCategoryId(),
			$keys[99] => $this->getReferralSource(),
			$keys[100] => $this->getPremiumChoice(),
			$keys[101] => $this->getPremiumSize(),
			$keys[102] => $this->getCcardApprovalNumber(),
			$keys[103] => $this->getCcardErrorCode(),
			$keys[104] => $this->getCcardAvsResult(),
			$keys[105] => $this->getProcessedDate(),
			$keys[106] => $this->getEventPlanning(),
			$keys[107] => $this->getWebInternet(),
			$keys[108] => $this->getFoundationContacts(),
			$keys[109] => $this->getAviationContacts(),
			$keys[110] => $this->getPrinting(),
			$keys[111] => $this->getMemberAopa(),
			$keys[112] => $this->getMemberKiwanis(),
			$keys[113] => $this->getMemberRotary(),
			$keys[114] => $this->getMemberLions(),
			$keys[115] => $this->getNovapointeId(),
			$keys[116] => $this->getPremiumShipDate(),
			$keys[117] => $this->getPremiumShipMethod(),
			$keys[118] => $this->getPremiumShipCost(),
			$keys[119] => $this->getPremiumShipTrackingNumber(),
			$keys[120] => $this->getSpousePilot(),
			$keys[121] => $this->getApplicantCopilot(),
			$keys[122] => $this->getPagerEmail(),
			$keys[123] => $this->getMember99s(),
			$keys[124] => $this->getMemberWia(),
			$keys[125] => $this->getMissionEmailOptin(),
			$keys[126] => $this->getHseatsInterest(),
			$keys[127] => $this->getMasterApplicationId(),
			$keys[128] => $this->getMasterMemberId(),
			$keys[129] => $this->getReferralSourceOther(),
			$keys[130] => $this->getSecondaryEmail(),
			$keys[131] => $this->getPaymentTransactionId(),
			$keys[132] => $this->getAircraftThirdIce(),
			$keys[133] => $this->getAircraftThirdId(),
			$keys[134] => $this->getAircraftThirdNNumber(),
			$keys[135] => $this->getAircraftThirdOwn(),
			$keys[136] => $this->getAircraftThirdSeats(),
			$keys[137] => $this->getDriversLicenseNumber(),
			$keys[138] => $this->getDriversLicenseState(),
			$keys[139] => $this->getEmergencyContactName(),
			$keys[140] => $this->getEmergencyContactPhone(),
			$keys[141] => $this->getCountry(),
			$keys[142] => $this->getMiddleName(),
			$keys[143] => $this->getSuffix(),
			$keys[144] => $this->getNickname(),
			$keys[145] => $this->getVeteran(),
			$keys[146] => $this->getGender(),
		);
		return $result;
	}
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 33:
				...
				break;
			case 34:
				$this->setOtherVolunteer($value);
				break;
			case 35:
				$this->setTShirtSize($value);
				break;
			case 36:
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[1], $arr)) $this->setCcardNumber($arr[$keys[1]]);
		if (array_key_exists($keys[2], $arr)) $this->setCcardCode($arr[$keys[2]]);
		if (array_key_exists($keys[3], $arr)) $this->setCcardExpire($arr[$keys[3]]);
		if (array_key_exists($keys[4], $arr)) $this->setMemberId($arr[$keys[4]]);
		if (array_key_exists($keys[5], $arr)) $this->setRenewal($arr[$keys[5]]);
		if (array_key_exists($keys[6], $arr)) $this->setDate($arr[$keys[6]]);
		if (array_key_exists($keys[7], $arr)) $this->setVocationClassId($arr[$keys[7]]);
		if (array_key_exists($keys[8], $arr)) $this->setCompany($arr[$keys[8]]);
		if (array_key_exists($keys[9], $arr)) $this->setLicenseType($arr[$keys[9]]);
		if (array_key_exists($keys[10], $arr)) $this->setIfr($arr[$keys[10]]);
		if (array_key_exists($keys[11], $arr)) $this->setMultiEngine($arr[$keys[11]]);
		if (array_key_exists($keys[12], $arr)) $this->setSeInstructor($arr[$keys[12]]);
		if (array_key_exists($keys[13], $arr)) $this->setMeInstructor($arr[$keys[13]]);
		if (array_key_exists($keys[14], $arr)) $this->setOtherRatings($arr[$keys[14]]);
		if (array_key_exists($keys[15], $arr)) $this->setTotalHours($arr[$keys[15]]);
		if (array_key_exists($keys[16], $arr)) $this->setFbo($arr[$keys[16]]);
		if (array_key_exists($keys[17], $arr)) $this->setMissionOrientation($arr[$keys[17]]);
		if (array_key_exists($keys[18], $arr)) $this->setMissionCoordination($arr[$keys[18]]);
		if (array_key_exists($keys[19], $arr)) $this->setPilotRecruitment($arr[$keys[19]]);
		if (array_key_exists($keys[20], $arr)) $this->setFundRaising($arr[$keys[20]]);
		if (array_key_exists($keys[21], $arr)) $this->setCelebrityContacts($arr[$keys[21]]);
		if (array_key_exists($keys[22], $arr)) $this->setHospitalOutreach($arr[$keys[22]]);
		if (array_key_exists($keys[23], $arr)) $this->setMemberMeetings($arr[$keys[23]]);
		if (array_key_exists($keys[24], $arr)) $this->setMediaRelations($arr[$keys[24]]);
		if (array_key_exists($keys[25], $arr)) $this->setTelephoneWork($arr[$keys[25]]);
		if (array_key_exists($keys[26], $arr)) $this->setComputers($arr[$keys[26]]);
		if (array_key_exists($keys[27], $arr)) $this->setClerical($arr[$keys[27]]);
		if (array_key_exists($keys[28], $arr)) $this->setPublicity($arr[$keys[28]]);
		if (array_key_exists($keys[29], $arr)) $this->setWriting($arr[$keys[29]]);
		if (array_key_exists($keys[30], $arr)) $this->setSpeakersBureau($arr[$keys[30]]);
		if (array_key_exists($keys[31], $arr)) $this->setExecutiveBoard($arr[$keys[31]]);
		if (array_key_exists($keys[32], $arr)) $this->setWingTeam($arr[$keys[32]]);
		if (array_key_exists($keys[33], $arr)) $this->setGraphicArts($arr[$keys[33]]);
		if (array_key_exists($keys[34], $arr)) $this->setOtherVolunteer($arr[$keys[34]]);
		if (array_key_exists($keys[35], $arr)) $this->setTShirtSize($arr[$keys[35]]);
		if (array_key_exists($keys[36], $arr)) $this->setDuesAmountPaid($arr[$keys[36]]);
		if (array_key_exists($keys[37], $arr)) $this->setMethodOfPayment($arr[$keys[37]]);
		if (array_key_exists($keys[38], $arr)) $this->setCheckNumber($arr[$keys[38]]);
		if (array_key_exists($keys[39], $arr)) $this->setDonationAmountPaid($arr[$keys[39]]);
		if (array_key_exists($keys[40], $arr)) $this->setTitle($arr[$keys[40]]);
		if (array_key_exists($keys[41], $arr)) $this->setFirstName($arr[$keys[41]]);
		if (array_key_exists($keys[42], $arr)) $this->setLastName($arr[$keys[42]]);
		if (array_key_exists($keys[43], $arr)) $this->setAddress1($arr[$keys[43]]);
		if (array_key_exists($keys[44], $arr)) $this->setAddress2($arr[$keys[44]]);
		if (array_key_exists($keys[45], $arr)) $this->setCity($arr[$keys[45]]);
		if (array_key_exists($keys[46], $arr)) $this->setState($arr[$keys[46]]);
		if (array_key_exists($keys[47], $arr)) $this->setZipcode($arr[$keys[47]]);
		if (array_key_exists($keys[48], $arr)) $this->setDayPhone($arr[$keys[48]]);
		if (array_key_exists($keys[49], $arr)) $this->setDayComment($arr[$keys[49]]);
		if (array_key_exists($keys[50], $arr)) $this->setEvePhone($arr[$keys[50]]);
		if (array_key_exists($keys[51], $arr)) $this->setEveComment($arr[$keys[51]]);
		if (array_key_exists($keys[52], $arr)) $this->setMobilePhone($arr[$keys[52]]);
		if (array_key_exists($keys[53], $arr)) $this->setMobileComment($arr[$keys[53]]);
		if (array_key_exists($keys[54], $arr)) $this->setPagerPhone($arr[$keys[54]]);
		if (array_key_exists($keys[55], $arr)) $this->setPagerComment($arr[$keys[55]]);
		if (array_key_exists($keys[56], $arr)) $this->setFaxPhone1($arr[$keys[56]]);
		if (array_key_exists($keys[57], $arr)) $this->setFaxComment1($arr[$keys[57]]);
		if (array_key_exists($keys[58], $arr)) $this->setFaxPhone2($arr[$keys[58]]);
		if (array_key_exists($keys[59], $arr)) $this->setFaxComment2($arr[$keys[59]]);
		if (array_key_exists($keys[60], $arr)) $this->setOtherPhone($arr[$keys[60]]);
		if (array_key_exists($keys[61], $arr)) $this->setOtherComment($arr[$keys[61]]);
		if (array_key_exists($keys[62], $arr)) $this->setEmail($arr[$keys[62]]);
		if (array_key_exists($keys[63], $arr)) $this->setSpouseFirstName($arr[$keys[63]]);
		if (array_key_exists($keys[64], $arr)) $this->setSpouseLastName($arr[$keys[64]]);
		if (array_key_exists($keys[65], $arr)) $this->setApplicantPilot($arr[$keys[65]]);
		if (array_key_exists($keys[66], $arr)) $this->setLanguagesSpoken($arr[$keys[66]]);
		if (array_key_exists($keys[67], $arr)) $this->setHomeBase($arr[$keys[67]]);
		if (array_key_exists($keys[68], $arr)) $this->setSecondaryHomeBases($arr[$keys[68]]);
		if (array_key_exists($keys[69], $arr)) $this->setAircraftPrimaryId($arr[$keys[69]]);
		if (array_key_exists($keys[70], $arr)) $this->setAircraftPrimaryOwn($arr[$keys[70]]);
		if (array_key_exists($keys[71], $arr)) $this->setAircraftPrimaryIce($arr[$keys[71]]);
		if (array_key_exists($keys[72], $arr)) $this->setAircraftPrimarySeats($arr[$keys[72]]);
		if (array_key_exists($keys[73], $arr)) $this->setAircraftPrimaryNNumber($arr[$keys[73]]);
		if (array_key_exists($keys[74], $arr)) $this->setAircraftSecondaryId($arr[$keys[74]]);
		if (array_key_exists($keys[75], $arr)) $this->setAircraftSecondaryOwn($arr[$keys[75]]);
		if (array_key_exists($keys[76], $arr)) $this->setAircraftSecondaryIce($arr[$keys[76]]);
		if (array_key_exists($keys[77], $arr)) $this->setAircraftSecondarySeats($arr[$keys[77]]);
		if (array_key_exists($keys[78], $arr)) $this->setAircraftSecondaryNNumber($arr[$keys[78]]);
		if (array_key_exists($keys[79], $arr)) $this->setPilotCertificate($arr[$keys[79]]);
		if (array_key_exists($keys[80], $arr)) $this->setMedicalClass($arr[$keys[80]]);
		if (array_key_exists($keys[81], $arr)) $this->setIfrHours($arr[$keys[81]]);
		if (array_key_exists($keys[82], $arr)) $this->setMultiHours($arr[$keys[82]]);
		if (array_key_exists($keys[83], $arr)) $this->setOtherHours($arr[$keys[83]]);
		if (array_key_exists($keys[84], $arr)) $this->setDateOfBirth($arr[$keys[84]]);
		if (array_key_exists($keys[85], $arr)) $this->setHeight($arr[$keys[85]]);
		if (array_key_exists($keys[86], $arr)) $this->setWeight($arr[$keys[86]]);
		if (array_key_exists($keys[87], $arr)) $this->setAvailabilityWeekdays($arr[$keys[87]]);
		if (array_key_exists($keys[88], $arr)) $this->setAvailabilityWeeknights($arr[$keys[88]]);
		if (array_key_exists($keys[89], $arr)) $this->setAvailabilityWeekends($arr[$keys[89]]);
		if (array_key_exists($keys[90], $arr)) $this->setAvailabilityNotice($arr[$keys[90]]);
		if (array_key_exists($keys[91], $arr)) $this->setAvailabilityLastMinute($arr[$keys[91]]);
		if (array_key_exists($keys[92], $arr)) $this->setAvailabilityCopilot($arr[$keys[92]]);
		if (array_key_exists($keys[93], $arr)) $this->setAffirmationAgreed($arr[$keys[93]]);
		if (array_key_exists($keys[94], $arr)) $this->setInsuranceAgreed($arr[$keys[94]]);
		if (array_key_exists($keys[95], $arr)) $this->setVolunteerInterest($arr[$keys[95]]);
		if (array_key_exists($keys[96], $arr)) $this->setCompanyPosition($arr[$keys[96]]);
		if (array_key_exists($keys[97], $arr)) $this->setCompanyMatchFunds($arr[$keys[97]]);
		if (array_key_exists($keys[98], $arr)) $this->setCompanyBusinessCategoryId($arr[$keys[98]]);
		if (array_key_exists($keys[99], $arr)) $this->setReferralSource($arr[$keys[99]]);
		if (array_key_exists($keys[100], $arr)) $this->setPremiumChoice($arr[$keys[100]]);
		if (array_key_exists($keys[101], $arr)) $this->setPremiumSize($arr[$keys[101]]);
		if (array_key_exists($keys[102], $arr)) $this->setCcardApprovalNumber($arr[$keys[102]]);
		if (array_key_exists($keys[103], $arr)) $this->setCcardErrorCode($arr[$keys[103]]);
		if (array_key_exists($keys[104], $arr)) $this->setCcardAvsResult($arr[$keys[104]]);
		if (array_key_exists($keys[105], $arr)) $this->setProcessedDate($arr[$keys[105]]);
		if (array_key_exists($keys[106], $arr)) $this->setEventPlanning($arr[$keys[106]]);
		if (array_key_exists($keys[107], $arr)) $this->setWebInternet($arr[$keys[107]]);
		if (array_key_exists($keys[108], $arr)) $this->setFoundationContacts($arr[$keys[108]]);
		if (array_key_exists($keys[109], $arr)) $this->setAviationContacts($arr[$keys[109]]);
		if (array_key_exists($keys[110], $arr)) $this->setPrinting($arr[$keys[110]]);
		if (array_key_exists($keys[111], $arr)) $this->setMemberAopa($arr[$keys[111]]);
		if (array_key_exists($keys[112], $arr)) $this->setMemberKiwanis($arr[$keys[112]]);
		if (array_key_exists($keys[113], $arr)) $this->setMemberRotary($arr[$keys[113]]);
		if (array_key_exists($keys[114], $arr)) $this->setMemberLions($arr[$keys[114]]);
		if (array_key_exists($keys[115], $arr)) $this->setNovapointeId($arr[$keys[115]]);
		if (array_key_exists($keys[116], $arr)) $this->setPremiumShipDate($arr[$keys[116]]);
		if (array_key_exists($keys[117], $arr)) $this->setPremiumShipMethod($arr[$keys[117]]);
		if (array_key_exists($keys[118], $arr)) $this->setPremiumShipCost($arr[$keys[118]]);
		if (array_key_exists($keys[119], $arr)) $this->setPremiumShipTrackingNumber($arr[$keys[119]]);
		if (array_key_exists($keys[120], $arr)) $this->setSpousePilot($arr[$keys[120]]);
		if (array_key_exists($keys[121], $arr)) $this->setApplicantCopilot($arr[$keys[121]]);
		if (array_key_exists($keys[122], $arr)) $this->setPagerEmail($arr[$keys[122]]);
		if (array_key_exists($keys[123], $arr)) $this->setMember99s($arr[$keys[123]]);
		if (array_key_exists($keys[124], $arr)) $this->setMemberWia($arr[$keys[124]]);
		if (array_key_exists($keys[125], $arr)) $this->setMissionEmailOptin($arr[$keys[125]]);
		if (array_key_exists($keys[126], $arr)) $this->setHseatsInterest($arr[$keys[126]]);
		if (array_key_exists($keys[127], $arr)) $this->setMasterApplicationId($arr[$keys[127]]);
		if (array_key_exists($keys[128], $arr)) $this->setMasterMemberId($arr[$keys[128]]);
		if (array_key_exists($keys[129], $arr)) $this->setReferralSourceOther($arr[$keys[129]]);
		if (array_key_exists($keys[130], $arr)) $this->setSecondaryEmail($arr[$keys[130]]);
		if (array_key_exists($keys[131], $arr)) $this->setPaymentTransactionId($arr[$keys[131]]);
		if (array_key_exists($keys[132], $arr)) $this->setAircraftThirdIce($arr[$keys[132]]);
		if (array_key_exists($keys[133], $arr)) $this->setAircraftThirdId($arr[$keys[133]]);
		if (array_key_exists($keys[134], $arr)) $this->setAircraftThirdNNumber($arr[$keys[134]]);
		if (array_key_exists($keys[135], $arr)) $this->setAircraftThirdOwn($arr[$keys[135]]);
		if (array_key_exists($keys[136], $arr)) $this->setAircraftThirdSeats($arr[$keys[136]]);
		if (array_key_exists($keys[137], $arr)) $this->setDriversLicenseNumber($arr[$keys[137]]);
		if (array_key_exists($keys[138], $arr)) $this->setDriversLicenseState($arr[$keys[138]]);
		if (array_key_exists($keys[139], $arr)) $this->setEmergencyContactName($arr[$keys[139]]);
		if (array_key_exists($keys[140], $arr)) $this->setEmergencyContactPhone($arr[$keys[140]]);
		if (array_key_exists($keys[141], $arr)) $this->setCountry($arr[$keys[141]]);
		if (array_key_exists($keys[142], $arr)) $this->setMiddleName($arr[$keys[142]]);
		if (array_key_exists($keys[143], $arr)) $this->setSuffix($arr[$keys[143]]);
		if (array_key_exists($keys[144], $arr)) $this->setNickname($arr[$keys[144]]);
		if (array_key_exists($keys[145], $arr)) $this->setVeteran($arr[$keys[145]]);
		if (array_key_exists($keys[146], $arr)) $this->setGender($arr[$keys[146]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ApplicationPeer::CCARD_NUMBER)) $criteria->add(ApplicationPeer::CCARD_NUMBER, $this->ccard_number);
		if ($this->isColumnModified(ApplicationPeer::CCARD_CODE)) $criteria->add(ApplicationPeer::CCARD_CODE, $this->ccard_code);
		if ($this->isColumnModified(ApplicationPeer::CCARD_EXPIRE)) $criteria->add(ApplicationPeer::CCARD_EXPIRE, $this->ccard_expire);
		if ($this->isColumnModified(ApplicationPeer::MEMBER_ID)) $criteria->add(ApplicationPeer::MEMBER_ID, $this->member_id);
		if ($this->isColumnModified(ApplicationPeer::RENEWAL)) $criteria->add(ApplicationPeer::RENEWAL, $this->renewal);
		if ($this->isColumnModified(ApplicationPeer::DATE)) $criteria->add(ApplicationPeer::DATE, $this->date);
		if ($this->isColumnModified(ApplicationPeer::VOCATION_CLASS_ID)) $criteria->add(ApplicationPeer::VOCATION_CLASS_ID, $this->vocation_class_id);
		if ($this->isColumnModified(ApplicationPeer::COMPANY)) $criteria->add(ApplicationPeer::COMPANY, $this->company);
		if ($this->isColumnModified(ApplicationPeer::LICENSE_TYPE)) $criteria->add(ApplicationPeer::LICENSE_TYPE, $this->license_type);
		if ($this->isColumnModified(ApplicationPeer::IFR)) $criteria->add(ApplicationPeer::IFR, $this->ifr);
		if ($this->isColumnModified(ApplicationPeer::MULTI_ENGINE)) $criteria->add(ApplicationPeer::MULTI_ENGINE, $this->multi_engine);
		if ($this->isColumnModified(ApplicationPeer::SE_INSTRUCTOR)) $criteria->add(ApplicationPeer::SE_INSTRUCTOR, $this->se_instructor);
		if ($this->isColumnModified(ApplicationPeer::ME_INSTRUCTOR)) $criteria->add(ApplicationPeer::ME_INSTRUCTOR, $this->me_instructor);
		if ($this->isColumnModified(ApplicationPeer::OTHER_RATINGS)) $criteria->add(ApplicationPeer::OTHER_RATINGS, $this->other_ratings);
		if ($this->isColumnModified(ApplicationPeer::TOTAL_HOURS)) $criteria->add(ApplicationPeer::TOTAL_HOURS, $this->total_hours);
		if ($this->isColumnModified(ApplicationPeer::FBO)) $criteria->add(ApplicationPeer::FBO, $this->fbo);
		if ($this->isColumnModified(ApplicationPeer::MISSION_ORIENTATION)) $criteria->add(ApplicationPeer::MISSION_ORIENTATION, $this->mission_orientation);
		if ($this->isColumnModified(ApplicationPeer::MISSION_COORDINATION)) $criteria->add(ApplicationPeer::MISSION_COORDINATION, $this->mission_coordination);
		if ($this->isColumnModified(ApplicationPeer::PILOT_RECRUITMENT)) $criteria->add(ApplicationPeer::PILOT_RECRUITMENT, $this->pilot_recruitment);
		if ($this->isColumnModified(ApplicationPeer::FUND_RAISING)) $criteria->add(ApplicationPeer::FUND_RAISING, $this->fund_raising);
		if ($this->isColumnModified(ApplicationPeer::CELEBRITY_CONTACTS)) $criteria->add(ApplicationPeer::CELEBRITY_CONTACTS, $this->celebrity_contacts);
		if ($this->isColumnModified(ApplicationPeer::HOSPITAL_OUTREACH)) $criteria->add(ApplicationPeer::HOSPITAL_OUTREACH, $this->hospital_outreach);
		if ($this->isColumnModified(ApplicationPeer::MEMBER_MEETINGS)) $criteria->add(ApplicationPeer::MEMBER_MEETINGS, $this->member_meetings);
		if ($this->isColumnModified(ApplicationPeer::MEDIA_RELATIONS)) $criteria->add(ApplicationPeer::MEDIA_RELATIONS, $this->media_relations);
		if ($this->isColumnModified(ApplicationPeer::TELEPHONE_WORK)) $criteria->add(ApplicationPeer::TELEPHONE_WORK, $this->telephone_work);
		if ($this->isColumnModified(ApplicationPeer::COMPUTERS)) $criteria->add(ApplicationPeer::COMPUTERS, $this->computers);
		if ($this->isColumnModified(ApplicationPeer::CLERICAL)) $criteria->add(ApplicationPeer::CLERICAL, $this->clerical);
		if ($this->isColumnModified(ApplicationPeer::PUBLICITY)) $criteria->add(ApplicationPeer::PUBLICITY, $this->publicity);
		if ($this->isColumnModified(ApplicationPeer::WRITING)) $criteria->add(ApplicationPeer::WRITING, $this->writing);
		if ($this->isColumnModified(ApplicationPeer::SPEAKERS_BUREAU)) $criteria->add(ApplicationPeer::SPEAKERS_BUREAU, $this->speakers_bureau);
		if ($this->isColumnModified(ApplicationPeer::EXECUTIVE_BOARD)) $criteria->add(ApplicationPeer::EXECUTIVE_BOARD, $this->executive_board);
		if ($this->isColumnModified(ApplicationPeer::WING_TEAM)) $criteria->add(ApplicationPeer::WING_TEAM, $this->wing_team);
		if ($this->isColumnModified(ApplicationPeer::GRAPHIC_ARTS)) $criteria->add(ApplicationPeer::GRAPHIC_ARTS, $this->graphic_arts);
		if ($this->isColumnModified(ApplicationPeer::OTHER_VOLUNTEER)) $criteria->add(ApplicationPeer::OTHER_VOLUNTEER, $this->other_volunteer);
		if ($this->isColumnModified(ApplicationPeer::T_SHIRT_SIZE)) $criteria->add(ApplicationPeer::T_SHIRT_SIZE, $this->t_shirt_size);
		if ($this->isColumnModified(ApplicationPeer::DUES_AMOUNT_PAID)) $criteria->add(ApplicationPeer::DUES_AMOUNT_PAID, $this->dues_amount_paid);
		if ($this->isColumnModified(ApplicationPeer::METHOD_OF_PAYMENT)) $criteria->add(ApplicationPeer::METHOD_OF_PAYMENT, $this->method_of_payment);
		if ($this->isColumnModified(ApplicationPeer::CHECK_NUMBER)) $criteria->add(ApplicationPeer::CHECK_NUMBER, $this->check_number);
		if ($this->isColumnModified(ApplicationPeer::DONATION_AMOUNT_PAID)) $criteria->add(ApplicationPeer::DONATION_AMOUNT_PAID, $this->donation_amount_paid);
		...
		if ($this->isColumnModified(ApplicationPeer::ADDRESS1)) $criteria->add(ApplicationPeer::ADDRESS1, $this->address1);
		if ($this->isColumnModified(ApplicationPeer::ADDRESS2)) $criteria->add(ApplicationPeer::ADDRESS2, $this->address2);
		if ($this->isColumnModified(ApplicationPeer::CITY)) $criteria->add(ApplicationPeer::CITY, $this->city);
		if ($this->isColumnModified(ApplicationPeer::STATE)) $criteria->add(ApplicationPeer::STATE, $this->state);
		if ($this->isColumnModified(ApplicationPeer::ZIPCODE)) $criteria->add(ApplicationPeer::ZIPCODE, $this->zipcode);
		if ($this->isColumnModified(ApplicationPeer::DAY_PHONE)) $criteria->add(ApplicationPeer::DAY_PHONE, $this->day_phone);
		if ($this->isColumnModified(ApplicationPeer::DAY_COMMENT)) $criteria->add(ApplicationPeer::DAY_COMMENT, $this->day_comment);
		if ($this->isColumnModified(ApplicationPeer::EVE_PHONE)) $criteria->add(ApplicationPeer::EVE_PHONE, $this->eve_phone);
		if ($this->isColumnModified(ApplicationPeer::EVE_COMMENT)) $criteria->add(ApplicationPeer::EVE_COMMENT, $this->eve_comment);
		if ($this->isColumnModified(ApplicationPeer::MOBILE_PHONE)) $criteria->add(ApplicationPeer::MOBILE_PHONE, $this->mobile_phone);
		if ($this->isColumnModified(ApplicationPeer::MOBILE_COMMENT)) $criteria->add(ApplicationPeer::MOBILE_COMMENT, $this->mobile_comment);
		if ($this->isColumnModified(ApplicationPeer::PAGER_PHONE)) $criteria->add(ApplicationPeer::PAGER_PHONE, $this->pager_phone);
		if ($this->isColumnModified(ApplicationPeer::PAGER_COMMENT)) $criteria->add(ApplicationPeer::PAGER_COMMENT, $this->pager_comment);
		if ($this->isColumnModified(ApplicationPeer::FAX_PHONE1)) $criteria->add(ApplicationPeer::FAX_PHONE1, $this->fax_phone1);
		if ($this->isColumnModified(ApplicationPeer::FAX_COMMENT1)) $criteria->add(ApplicationPeer::FAX_COMMENT1, $this->fax_comment1);
		if ($this->isColumnModified(ApplicationPeer::FAX_PHONE2)) $criteria->add(ApplicationPeer::FAX_PHONE2, $this->fax_phone2);
		if ($this->isColumnModified(ApplicationPeer::FAX_COMMENT2)) $criteria->add(ApplicationPeer::FAX_COMMENT2, $this->fax_comment2);
		if ($this->isColumnModified(ApplicationPeer::OTHER_PHONE)) $criteria->add(ApplicationPeer::OTHER_PHONE, $this->other_phone);
		if ($this->isColumnModified(ApplicationPeer::OTHER_COMMENT)) $criteria->add(ApplicationPeer::OTHER_COMMENT, $this->other_comment);
		if ($this->isColumnModified(ApplicationPeer::EMAIL)) $criteria->add(ApplicationPeer::EMAIL, $this->email);
		if ($this->isColumnModified(ApplicationPeer::SPOUSE_FIRST_NAME)) $criteria->add(ApplicationPeer::SPOUSE_FIRST_NAME, $this->spouse_first_name);
		if ($this->isColumnModified(ApplicationPeer::SPOUSE_LAST_NAME)) $criteria->add(ApplicationPeer::SPOUSE_LAST_NAME, $this->spouse_last_name);
		if ($this->isColumnModified(ApplicationPeer::APPLICANT_PILOT)) $criteria->add(ApplicationPeer::APPLICANT_PILOT, $this->applicant_pilot);
		if ($this->isColumnModified(ApplicationPeer::LANGUAGES_SPOKEN)) $criteria->add(ApplicationPeer::LANGUAGES_SPOKEN, $this->languages_spoken);
		if ($this->isColumnModified(ApplicationPeer::HOME_BASE)) $criteria->add(ApplicationPeer::HOME_BASE, $this->home_base);
		if ($this->isColumnModified(ApplicationPeer::SECONDARY_HOME_BASES)) $criteria->add(ApplicationPeer::SECONDARY_HOME_BASES, $this->secondary_home_bases);
		if ($this->isColumnModified(ApplicationPeer::AIRCRAFT_PRIMARY_ID)) $criteria->add(ApplicationPeer::AIRCRAFT_PRIMARY_ID, $this->aircraft_primary_id);
		if ($this->isColumnModified(ApplicationPeer::AIRCRAFT_PRIMARY_OWN)) $criteria->add(ApplicationPeer::AIRCRAFT_PRIMARY_OWN, $this->aircraft_primary_own);
		if ($this->isColumnModified(ApplicationPeer::AIRCRAFT_PRIMARY_ICE)) $criteria->add(ApplicationPeer::AIRCRAFT_PRIMARY_ICE, $this->aircraft_primary_ice);
		if ($this->isColumnModified(ApplicationPeer::AIRCRAFT_PRIMARY_SEATS)) $criteria->add(ApplicationPeer::AIRCRAFT_PRIMARY_SEATS, $this->aircraft_primary_seats);
		if ($this->isColumnModified(ApplicationPeer::AIRCRAFT_PRIMARY_N_NUMBER)) $criteria->add(ApplicationPeer::AIRCRAFT_PRIMARY_N_NUMBER, $this->aircraft_primary_n_number);
		if ($this->isColumnModified(ApplicationPeer::AIRCRAFT_SECONDARY_ID)) $criteria->add(ApplicationPeer::AIRCRAFT_SECONDARY_ID, $this->aircraft_secondary_id);
		if ($this->isColumnModified(ApplicationPeer::AIRCRAFT_SECONDARY_OWN)) $criteria->add(ApplicationPeer::AIRCRAFT_SECONDARY_OWN, $this->aircraft_secondary_own);
		if ($this->isColumnModified(ApplicationPeer::AIRCRAFT_SECONDARY_ICE)) $criteria->add(ApplicationPeer::AIRCRAFT_SECONDARY_ICE, $this->aircraft_secondary_ice);
		if ($this->isColumnModified(ApplicationPeer::AIRCRAFT_SECONDARY_SEATS)) $criteria->add(ApplicationPeer::AIRCRAFT_SECONDARY_SEATS, $this->aircraft_secondary_seats);
		if ($this->isColumnModified(ApplicationPeer::AIRCRAFT_SECONDARY_N_NUMBER)) $criteria->add(ApplicationPeer::AIRCRAFT_SECONDARY_N_NUMBER, $this->aircraft_secondary_n_number);
		if ($this->isColumnModified(ApplicationPeer::PILOT_CERTIFICATE)) $criteria->add(ApplicationPeer::PILOT_CERTIFICATE, $this->pilot_certificate);
		if ($this->isColumnModified(ApplicationPeer::MEDICAL_CLASS)) $criteria->add(ApplicationPeer::MEDICAL_CLASS, $this->medical_class);
		if ($this->isColumnModified(ApplicationPeer::IFR_HOURS)) $criteria->add(ApplicationPeer::IFR_HOURS, $this->ifr_hours);
		if ($this->isColumnModified(ApplicationPeer::MULTI_HOURS)) $criteria->add(ApplicationPeer::MULTI_HOURS, $this->multi_hours);
		if ($this->isColumnModified(ApplicationPeer::OTHER_HOURS)) $criteria->add(ApplicationPeer::OTHER_HOURS, $this->other_hours);
		...
		if ($this->isColumnModified(ApplicationPeer::WEIGHT)) $criteria->add(ApplicationPeer::WEIGHT, $this->weight);
		if ($this->isColumnModified(ApplicationPeer::AVAILABILITY_WEEKDAYS)) $criteria->add(ApplicationPeer::AVAILABILITY_WEEKDAYS, $this->availability_weekdays);
		if ($this->isColumnModified(ApplicationPeer::AVAILABILITY_WEEKNIGHTS)) $criteria->add(ApplicationPeer::AVAILABILITY_WEEKNIGHTS, $this->availability_weeknights);
		if ($this->isColumnModified(ApplicationPeer::AVAILABILITY_WEEKENDS)) $criteria->add(ApplicationPeer::AVAILABILITY_WEEKENDS, $this->availability_weekends);
		if ($this->isColumnModified(ApplicationPeer::AVAILABILITY_NOTICE)) $criteria->add(ApplicationPeer::AVAILABILITY_NOTICE, $this->availability_notice);
		if ($this->isColumnModified(ApplicationPeer::AVAILABILITY_LAST_MINUTE)) $criteria->add(ApplicationPeer::AVAILABILITY_LAST_MINUTE, $this->availability_last_minute);
		if ($this->isColumnModified(ApplicationPeer::AVAILABILITY_COPILOT)) $criteria->add(ApplicationPeer::AVAILABILITY_COPILOT, $this->availability_copilot);
		if ($this->isColumnModified(ApplicationPeer::AFFIRMATION_AGREED)) $criteria->add(ApplicationPeer::AFFIRMATION_AGREED, $this->affirmation_agreed);
		if ($this->isColumnModified(ApplicationPeer::INSURANCE_AGREED)) $criteria->add(ApplicationPeer::INSURANCE_AGREED, $this->insurance_agreed);
		if ($this->isColumnModified(ApplicationPeer::VOLUNTEER_INTEREST)) $criteria->add(ApplicationPeer::VOLUNTEER_INTEREST, $this->volunteer_interest);
		if ($this->isColumnModified(ApplicationPeer::COMPANY_POSITION)) $criteria->add(ApplicationPeer::COMPANY_POSITION, $this->company_position);
		if ($this->isColumnModified(ApplicationPeer::COMPANY_MATCH_FUNDS)) $criteria->add(ApplicationPeer::COMPANY_MATCH_FUNDS, $this->company_match_funds);
		if ($this->isColumnModified(ApplicationPeer::COMPANY_BUSINESS_CATEGORY_ID)) $criteria->add(ApplicationPeer::COMPANY_BUSINESS_CATEGORY_ID, $this->company_business_category_id);
		if ($this->isColumnModified(ApplicationPeer::REFERRAL_SOURCE)) $criteria->add(ApplicationPeer::REFERRAL_SOURCE, $this->referral_source);
		if ($this->isColumnModified(ApplicationPeer::PREMIUM_CHOICE)) $criteria->add(ApplicationPeer::PREMIUM_CHOICE, $this->premium_choice);
		if ($this->isColumnModified(ApplicationPeer::PREMIUM_SIZE)) $criteria->add(ApplicationPeer::PREMIUM_SIZE, $this->premium_size);
		if ($this->isColumnModified(ApplicationPeer::CCARD_APPROVAL_NUMBER)) $criteria->add(ApplicationPeer::CCARD_APPROVAL_NUMBER, $this->ccard_approval_number);
		if ($this->isColumnModified(ApplicationPeer::CCARD_ERROR_CODE)) $criteria->add(ApplicationPeer::CCARD_ERROR_CODE, $this->ccard_error_code);
		if ($this->isColumnModified(ApplicationPeer::CCARD_AVS_RESULT)) $criteria->add(ApplicationPeer::CCARD_AVS_RESULT, $this->ccard_avs_result);
		if ($this->isColumnModified(ApplicationPeer::PROCESSED_DATE)) $criteria->add(ApplicationPeer::PROCESSED_DATE, $this->processed_date);
		if ($this->isColumnModified(ApplicationPeer::EVENT_PLANNING)) $criteria->add(ApplicationPeer::EVENT_PLANNING, $this->event_planning);
		if ($this->isColumnModified(ApplicationPeer::WEB_INTERNET)) $criteria->add(ApplicationPeer::WEB_INTERNET, $this->web_internet);
		if ($this->isColumnModified(ApplicationPeer::FOUNDATION_CONTACTS)) $criteria->add(ApplicationPeer::FOUNDATION_CONTACTS, $this->foundation_contacts);
		if ($this->isColumnModified(ApplicationPeer::AVIATION_CONTACTS)) $criteria->add(ApplicationPeer::AVIATION_CONTACTS, $this->aviation_contacts);
		if ($this->isColumnModified(ApplicationPeer::PRINTING)) $criteria->add(ApplicationPeer::PRINTING, $this->printing);
		if ($this->isColumnModified(ApplicationPeer::MEMBER_AOPA)) $criteria->add(ApplicationPeer::MEMBER_AOPA, $this->member_aopa);
		if ($this->isColumnModified(ApplicationPeer::MEMBER_KIWANIS)) $criteria->add(ApplicationPeer::MEMBER_KIWANIS, $this->member_kiwanis);
		if ($this->isColumnModified(ApplicationPeer::MEMBER_ROTARY)) $criteria->add(ApplicationPeer::MEMBER_ROTARY, $this->member_rotary);
		if ($this->isColumnModified(ApplicationPeer::MEMBER_LIONS)) $criteria->add(ApplicationPeer::MEMBER_LIONS, $this->member_lions);
		if ($this->isColumnModified(ApplicationPeer::NOVAPOINTE_ID)) $criteria->add(ApplicationPeer::NOVAPOINTE_ID, $this->novapointe_id);
		if ($this->isColumnModified(ApplicationPeer::PREMIUM_SHIP_DATE)) $criteria->add(ApplicationPeer::PREMIUM_SHIP_DATE, $this->premium_ship_date);
		if ($this->isColumnModified(ApplicationPeer::PREMIUM_SHIP_METHOD)) $criteria->add(ApplicationPeer::PREMIUM_SHIP_METHOD, $this->premium_ship_method);
		if ($this->isColumnModified(ApplicationPeer::PREMIUM_SHIP_COST)) $criteria->add(ApplicationPeer::PREMIUM_SHIP_COST, $this->premium_ship_cost);
		if ($this->isColumnModified(ApplicationPeer::PREMIUM_SHIP_TRACKING_NUMBER)) $criteria->add(ApplicationPeer::PREMIUM_SHIP_TRACKING_NUMBER, $this->premium_ship_tracking_number);
		if ($this->isColumnModified(ApplicationPeer::SPOUSE_PILOT)) $criteria->add(ApplicationPeer::SPOUSE_PILOT, $this->spouse_pilot);
		if ($this->isColumnModified(ApplicationPeer::APPLICANT_COPILOT)) $criteria->add(ApplicationPeer::APPLICANT_COPILOT, $this->applicant_copilot);
		if ($this->isColumnModified(ApplicationPeer::PAGER_EMAIL)) $criteria->add(ApplicationPeer::PAGER_EMAIL, $this->pager_email);
		if ($this->isColumnModified(ApplicationPeer::MEMBER_99S)) $criteria->add(ApplicationPeer::MEMBER_99S, $this->member_99s);
		if ($this->isColumnModified(ApplicationPeer::MEMBER_WIA)) $criteria->add(ApplicationPeer::MEMBER_WIA, $this->member_wia);
		if ($this->isColumnModified(ApplicationPeer::MISSION_EMAIL_OPTIN)) $criteria->add(ApplicationPeer::MISSION_EMAIL_OPTIN, $this->mission_email_optin);
		if ($this->isColumnModified(ApplicationPeer::HSEATS_INTEREST)) $criteria->add(ApplicationPeer::HSEATS_INTEREST, $this->hseats_interest);
		if ($this->isColumnModified(ApplicationPeer::MASTER_APPLICATION_ID)) $criteria->add(ApplicationPeer::MASTER_APPLICATION_ID, $this->master_application_id);
		if ($this->isColumnModified(ApplicationPeer::MASTER_MEMBER_ID)) $criteria->add(ApplicationPeer::MASTER_MEMBER_ID, $this->master_member_id);
		if ($this->isColumnModified(ApplicationPeer::REFERRAL_SOURCE_OTHER)) $criteria->add(ApplicationPeer::REFERRAL_SOURCE_OTHER, $this->referral_source_other);
		if ($this->isColumnModified(ApplicationPeer::SECONDARY_EMAIL)) $criteria->add(ApplicationPeer::SECONDARY_EMAIL, $this->secondary_email);
		if ($this->isColumnModified(ApplicationPeer::PAYMENT_TRANSACTION_ID)) $criteria->add(ApplicationPeer::PAYMENT_TRANSACTION_ID, $this->payment_transaction_id);
		if ($this->isColumnModified(ApplicationPeer::AIRCRAFT_THIRD_ICE)) $criteria->add(ApplicationPeer::AIRCRAFT_THIRD_ICE, $this->aircraft_third_ice);
		if ($this->isColumnModified(ApplicationPeer::AIRCRAFT_THIRD_ID)) $criteria->add(ApplicationPeer::AIRCRAFT_THIRD_ID, $this->aircraft_third_id);
		if ($this->isColumnModified(ApplicationPeer::AIRCRAFT_THIRD_N_NUMBER)) $criteria->add(ApplicationPeer::AIRCRAFT_THIRD_N_NUMBER, $this->aircraft_third_n_number);
		if ($this->isColumnModified(ApplicationPeer::AIRCRAFT_THIRD_OWN)) $criteria->add(ApplicationPeer::AIRCRAFT_THIRD_OWN, $this->aircraft_third_own);
		if ($this->isColumnModified(ApplicationPeer::AIRCRAFT_THIRD_SEATS)) $criteria->add(ApplicationPeer::AIRCRAFT_THIRD_SEATS, $this->aircraft_third_seats);
		if ($this->isColumnModified(ApplicationPeer::DRIVERS_LICENSE_NUMBER)) $criteria->add(ApplicationPeer::DRIVERS_LICENSE_NUMBER, $this->drivers_license_number);
		if ($this->isColumnModified(ApplicationPeer::DRIVERS_LICENSE_STATE)) $criteria->add(ApplicationPeer::DRIVERS_LICENSE_STATE, $this->drivers_license_state);
		if ($this->isColumnModified(ApplicationPeer::EMERGENCY_CONTACT_NAME)) $criteria->add(ApplicationPeer::EMERGENCY_CONTACT_NAME, $this->emergency_contact_name);
		if ($this->isColumnModified(ApplicationPeer::EMERGENCY_CONTACT_PHONE)) $criteria->add(ApplicationPeer::EMERGENCY_CONTACT_PHONE, $this->emergency_contact_phone);
		if ($this->isColumnModified(ApplicationPeer::COUNTRY)) $criteria->add(ApplicationPeer::COUNTRY, $this->country);
		if ($this->isColumnModified(ApplicationPeer::MIDDLE_NAME)) $criteria->add(ApplicationPeer::MIDDLE_NAME, $this->middle_name);
		if ($this->isColumnModified(ApplicationPeer::SUFFIX)) $criteria->add(ApplicationPeer::SUFFIX, $this->suffix);
		if ($this->isColumnModified(ApplicationPeer::NICKNAME)) $criteria->add(ApplicationPeer::NICKNAME, $this->nickname);
		if ($this->isColumnModified(ApplicationPeer::VETERAN)) $criteria->add(ApplicationPeer::VETERAN, $this->veteran);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setVocationClassId($this->vocation_class_id);
		...
		$copyObj->setMemberMeetings($this->member_meetings);
		...
		$copyObj->setExecutiveBoard($this->executive_board);

		$copyObj->setWingTeam($this->wing_team);

		$copyObj->setGraphicArts($this->graphic_arts);

		$copyObj->setOtherVolunteer($this->other_volunteer);

		$copyObj->setTShirtSize($this->t_shirt_size);
	...
	public function getMember(PropelPDO $con = null)
	{
		if ($this->aMember === null && ($this->member_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aMember->addApplications($this);
			 */
		}
		return $this->aMember;
	}
	...
	/**
	 * Declares an association between this object and a VocationClass object.
	 *
	 * @param      VocationClass $v
	 * @return     Application The current object (for fluent API support)
	 * @throws     PropelException
	 */
	public function setVocationClass(VocationClass $v = null)
	{
		if ($v === null) {
			$this->setVocationClassId(NULL);
		} else {
			$this->setVocationClassId($v->getId());
		}

		$this->aVocationClass = $v;

		// Add binding for other direction of this n:n relationship.
		// If this object has already been added to the VocationClass object, it will not be re-added.
		if ($v !== null) {
			$v->addApplication($this);
		}
	...
	/**
	 * Get the associated VocationClass object
	 *
	 * @param      PropelPDO Optional Connection object.
	 * @return     VocationClass The associated VocationClass object.
	 * @throws     PropelException
	 */
	public function getVocationClass(PropelPDO $con = null)
	{
		if ($this->aVocationClass === null && ($this->vocation_class_id !== null)) {
			$c = new Criteria(VocationClassPeer::DATABASE_NAME);
			$c->add(VocationClassPeer::ID, $this->vocation_class_id);
			$this->aVocationClass = VocationClassPeer::doSelectOne($c, $con);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aVocationClass->addApplications($this);
			 */
		}
		return $this->aVocationClass;
	}

	/**
	 * Declares an association between this object and a RefSource object.
	 *
	 * @param      RefSource $v
	 * @return     Application The current object (for fluent API support)
	 * @throws     PropelException
	 */
	public function setRefSource(RefSource $v = null)
	{
		if ($v === null) {
			$this->setReferralSource(NULL);
		} else {
			$this->setReferralSource($v->getId());
		}

		$this->aRefSource = $v;

		// Add binding for other direction of this n:n relationship.
		// If this object has already been added to the RefSource object, it will not be re-added.
		if ($v !== null) {
			$v->addApplication($this);
		}
	...
	{
		if ($this->aRefSource === null && ($this->referral_source !== null)) {
			$c = new Criteria(RefSourcePeer::DATABASE_NAME);
			$c->add(RefSourcePeer::ID, $this->referral_source);
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aRefSource->addApplications($this);
			 */
		}
