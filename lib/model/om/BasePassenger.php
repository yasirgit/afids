...
/**
 * Base class that represents a row from the 'passenger' table.
 *
 * 
 *
 ...
 */
abstract class BasePassenger extends BaseObject  implements Persistent {


  const PEER = 'PassengerPeer';
	...
	/**
	 * The value for the facility_city field.
	 * @var        string
	 */
	protected $facility_city;

	/**
	 * The value for the facility_state field.
	 * @var        string
	 */
	...
	/**
	 * @var        PassengerIllnessCategory
	 */
	protected $aPassengerIllnessCategory;
	...
	/**
	 * Initializes internal state of BasePassenger object.
	 * @see        applyDefaults()
	 */
	...
	/**
	 * Get the [facility_city] column value.
	 * 
	 * @return     string
	 */
	...
	/**
	 * Get the [facility_state] column value.
	 * 
	 * @return     string
	 */
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = PassengerPeer::ID;
		}
	...
	public function setPersonId($v)
	{
		...
		if ($this->person_id !== $v) {
			$this->person_id = $v;
			$this->modifiedColumns[] = PassengerPeer::PERSON_ID;
		}
	...
	public function setPassengerTypeId($v)
	{
		...
		if ($this->passenger_type_id !== $v) {
			...
			$this->modifiedColumns[] = PassengerPeer::PASSENGER_TYPE_ID;
		}

		if ($this->aPassengerType !== null && $this->aPassengerType->getId() !== $v) {
			$this->aPassengerType = null;
		}
	...
	public function setParent($v)
	{
		...
		if ($this->parent !== $v) {
			$this->parent = $v;
			$this->modifiedColumns[] = PassengerPeer::PARENT;
		}
	...
	public function setDateOfBirth($v)
	{
		...
		if ( $this->date_of_birth !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = PassengerPeer::DATE_OF_BIRTH;
			}
	...
	public function setIllness($v)
	{
		...
		if ($this->illness !== $v) {
			$this->illness = $v;
			$this->modifiedColumns[] = PassengerPeer::ILLNESS;
		}
	...
	public function setFinancial($v)
	{
		...
		if ($this->financial !== $v) {
			$this->financial = $v;
			$this->modifiedColumns[] = PassengerPeer::FINANCIAL;
		}
	...
	public function setWeight($v)
	{
		...
		if ($this->weight !== $v) {
			$this->weight = $v;
			$this->modifiedColumns[] = PassengerPeer::WEIGHT;
		}
	...
	public function setPublicConsiderations($v)
	{
		...
		if ($this->public_considerations !== $v) {
			...
			$this->modifiedColumns[] = PassengerPeer::PUBLIC_CONSIDERATIONS;
		}
	...
	public function setPrivateConsiderations($v)
	{
		...
		if ($this->private_considerations !== $v) {
			...
			$this->modifiedColumns[] = PassengerPeer::PRIVATE_CONSIDERATIONS;
		}
	...
	public function setReleasingPhysician($v)
	{
		...
		if ($this->releasing_physician !== $v) {
			...
			$this->modifiedColumns[] = PassengerPeer::RELEASING_PHYSICIAN;
		}
	...
	public function setReleasingPhone($v)
	{
		...
		if ($this->releasing_phone !== $v) {
			...
			$this->modifiedColumns[] = PassengerPeer::RELEASING_PHONE;
		}
	...
	public function setLodgingName($v)
	{
		...
		if ($this->lodging_name !== $v) {
			$this->lodging_name = $v;
			$this->modifiedColumns[] = PassengerPeer::LODGING_NAME;
		}
	...
	public function setLodgingPhone($v)
	{
		...
		if ($this->lodging_phone !== $v) {
			...
			$this->modifiedColumns[] = PassengerPeer::LODGING_PHONE;
		}
	...
	public function setLodgingPhoneComment($v)
	{
		...
		if ($this->lodging_phone_comment !== $v) {
			...
			$this->modifiedColumns[] = PassengerPeer::LODGING_PHONE_COMMENT;
		}
	...
	public function setFacilityName($v)
	{
		...
		if ($this->facility_name !== $v) {
			...
			$this->modifiedColumns[] = PassengerPeer::FACILITY_NAME;
		}
	...
	/**
	 * Set the value of [facility_city] column.
	 * 
	 * @param      string $v new value
	 * @return     Passenger The current object (for fluent API support)
	 */
	public function setFacilityCity($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->facility_city !== $v) {
			$this->facility_city = $v;
			$this->modifiedColumns[] = PassengerPeer::FACILITY_CITY;
		}
	...
	/**
	 * Set the value of [facility_state] column.
	 * 
	 * @param      string $v new value
	 * @return     Passenger The current object (for fluent API support)
	 */
	public function setFacilityState($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->facility_state !== $v) {
			$this->facility_state = $v;
			$this->modifiedColumns[] = PassengerPeer::FACILITY_STATE;
		}
	...
	public function setFacilityPhone($v)
	{
		...
		if ($this->facility_phone !== $v) {
			...
			$this->modifiedColumns[] = PassengerPeer::FACILITY_PHONE;
		}
	...
	public function setFacilityPhoneComment($v)
	{
		...
		if ($this->facility_phone_comment !== $v) {
			...
			$this->modifiedColumns[] = PassengerPeer::FACILITY_PHONE_COMMENT;
		}
	...
	public function setRequesterId($v)
	{
		...
		if ($this->requester_id !== $v) {
			$this->requester_id = $v;
			$this->modifiedColumns[] = PassengerPeer::REQUESTER_ID;
		}

		if ($this->aRequester !== null && $this->aRequester->getId() !== $v) {
			$this->aRequester = null;
		}
	...
	public function setMedicalReleaseRequested($v)
	{
		...
		if ( $this->medical_release_requested !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = PassengerPeer::MEDICAL_RELEASE_REQUESTED;
			}
		} // if either are not null
	...
	public function setMedicalReleaseReceived($v)
	{
		...
		if ( $this->medical_release_received !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = PassengerPeer::MEDICAL_RELEASE_RECEIVED;
			}
		} // if either are not null
	...
	public function setPassengerIllnessCategoryId($v)
	{
		...
		if ($this->passenger_illness_category_id !== $v) {
			...
			$this->modifiedColumns[] = PassengerPeer::PASSENGER_ILLNESS_CATEGORY_ID;
		}

		if ($this->aPassengerIllnessCategory !== null && $this->aPassengerIllnessCategory->getId() !== $v) {
			$this->aPassengerIllnessCategory = null;
		}
	...
	public function setReleasingFax1($v)
	{
		...
		if ($this->releasing_fax1 !== $v) {
			...
			$this->modifiedColumns[] = PassengerPeer::RELEASING_FAX1;
		}
	...
	public function setReleasingFax1Comment($v)
	{
		...
		if ($this->releasing_fax1_comment !== $v) {
			...
			$this->modifiedColumns[] = PassengerPeer::RELEASING_FAX1_COMMENT;
		}
	...
	public function setReleasingEmail($v)
	{
		...
		if ($this->releasing_email !== $v) {
			...
			$this->modifiedColumns[] = PassengerPeer::RELEASING_EMAIL;
		}
	...
	public function setTreatingPhysician($v)
	{
		...
		if ($this->treating_physician !== $v) {
			...
			$this->modifiedColumns[] = PassengerPeer::TREATING_PHYSICIAN;
		}
	...
	public function setTreatingPhone($v)
	{
		...
		if ($this->treating_phone !== $v) {
			...
			$this->modifiedColumns[] = PassengerPeer::TREATING_PHONE;
		}
	...
	public function setTreatingFax1($v)
	{
		...
		if ($this->treating_fax1 !== $v) {
			...
			$this->modifiedColumns[] = PassengerPeer::TREATING_FAX1;
		}
	...
	public function setTreatingFax1Comment($v)
	{
		...
		if ($this->treating_fax1_comment !== $v) {
			...
			$this->modifiedColumns[] = PassengerPeer::TREATING_FAX1_COMMENT;
		}
	...
	public function setTreatingEmail($v)
	{
		...
		if ($this->treating_email !== $v) {
			...
			$this->modifiedColumns[] = PassengerPeer::TREATING_EMAIL;
		}
	...
	public function setLanguageSpoken($v)
	{
		...
		if ($this->language_spoken !== $v) {
			...
			$this->modifiedColumns[] = PassengerPeer::LANGUAGE_SPOKEN;
		}
	...
	public function setBestContactMethod($v)
	{
		...
		if ($this->best_contact_method !== $v) {
			...
			$this->modifiedColumns[] = PassengerPeer::BEST_CONTACT_METHOD;
		}
	...
	public function setEmergencyContactName($v)
	{
		...
		if ($this->emergency_contact_name !== $v) {
			...
			$this->modifiedColumns[] = PassengerPeer::EMERGENCY_CONTACT_NAME;
		}
	...
	public function setEmergencyContactPrimaryPhone($v)
	{
		...
		if ($this->emergency_contact_primary_phone !== $v) {
			...
			$this->modifiedColumns[] = PassengerPeer::EMERGENCY_CONTACT_PRIMARY_PHONE;
		}
	...
	public function setEmergencyContactSecondaryPhone($v)
	{
		...
		if ($this->emergency_contact_secondary_phone !== $v) {
			...
			$this->modifiedColumns[] = PassengerPeer::EMERGENCY_CONTACT_SECONDARY_PHONE;
		}
	...
	public function setEmergencyContactPrimaryComment($v)
	{
		...
		if ($this->emergency_contact_primary_comment !== $v) {
			...
			$this->modifiedColumns[] = PassengerPeer::EMERGENCY_CONTACT_PRIMARY_COMMENT;
		}
	...
	public function setEmergencyContactSecondaryComment($v)
	{
		...
		if ($this->emergency_contact_secondary_comment !== $v) {
			...
			$this->modifiedColumns[] = PassengerPeer::EMERGENCY_CONTACT_SECONDARY_COMMENT;
		}
	...
	public function setTravelHistoryNotes($v)
	{
		...
		if ($this->travel_history_notes !== $v) {
			...
			$this->modifiedColumns[] = PassengerPeer::TRAVEL_HISTORY_NOTES;
		}
	...
	public function setNeedMedicalRelease($v)
	{
		...
		if ($this->need_medical_release !== $v) {
			...
			$this->modifiedColumns[] = PassengerPeer::NEED_MEDICAL_RELEASE;
		}
	...
	public function setGroundTransportationComment($v)
	{
		...
		if ($this->ground_transportation_comment !== $v) {
			...
			$this->modifiedColumns[] = PassengerPeer::GROUND_TRANSPORTATION_COMMENT;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->facility_city = ($row[$startcol + 16] !== null) ? (string) $row[$startcol + 16] : null;
			$this->facility_state = ($row[$startcol + 17] !== null) ? (string) $row[$startcol + 17] : null;
			$this->facility_phone = ($row[$startcol + 18] !== null) ? (string) $row[$startcol + 18] : null;
			$this->facility_phone_comment = ($row[$startcol + 19] !== null) ? (string) $row[$startcol + 19] : null;
			$this->requester_id = ($row[$startcol + 20] !== null) ? (int) $row[$startcol + 20] : null;
			$this->medical_release_requested = ($row[$startcol + 21] !== null) ? (string) $row[$startcol + 21] : null;
			$this->medical_release_received = ($row[$startcol + 22] !== null) ? (string) $row[$startcol + 22] : null;
			$this->passenger_illness_category_id = ($row[$startcol + 23] !== null) ? (int) $row[$startcol + 23] : null;
			$this->releasing_fax1 = ($row[$startcol + 24] !== null) ? (int) $row[$startcol + 24] : null;
			$this->releasing_fax1_comment = ($row[$startcol + 25] !== null) ? (string) $row[$startcol + 25] : null;
			$this->releasing_email = ($row[$startcol + 26] !== null) ? (string) $row[$startcol + 26] : null;
			$this->treating_physician = ($row[$startcol + 27] !== null) ? (string) $row[$startcol + 27] : null;
			$this->treating_phone = ($row[$startcol + 28] !== null) ? (int) $row[$startcol + 28] : null;
			$this->treating_fax1 = ($row[$startcol + 29] !== null) ? (string) $row[$startcol + 29] : null;
			$this->treating_fax1_comment = ($row[$startcol + 30] !== null) ? (string) $row[$startcol + 30] : null;
			$this->treating_email = ($row[$startcol + 31] !== null) ? (string) $row[$startcol + 31] : null;
			$this->language_spoken = ($row[$startcol + 32] !== null) ? (string) $row[$startcol + 32] : null;
			$this->best_contact_method = ($row[$startcol + 33] !== null) ? (string) $row[$startcol + 33] : null;
			$this->emergency_contact_name = ($row[$startcol + 34] !== null) ? (string) $row[$startcol + 34] : null;
			$this->emergency_contact_primary_phone = ($row[$startcol + 35] !== null) ? (string) $row[$startcol + 35] : null;
			$this->emergency_contact_secondary_phone = ($row[$startcol + 36] !== null) ? (string) $row[$startcol + 36] : null;
			$this->emergency_contact_primary_comment = ($row[$startcol + 37] !== null) ? (string) $row[$startcol + 37] : null;
			$this->emergency_contact_secondary_comment = ($row[$startcol + 38] !== null) ? (string) $row[$startcol + 38] : null;
			$this->travel_history_notes = ($row[$startcol + 39] !== null) ? (string) $row[$startcol + 39] : null;
			$this->need_medical_release = ($row[$startcol + 40] !== null) ? (int) $row[$startcol + 40] : null;
			$this->ground_transportation_comment = ($row[$startcol + 41] !== null) ? (string) $row[$startcol + 41] : null;
			$this->resetModified();
			...
			return $startcol + 42; // 42 = PassengerPeer::NUM_COLUMNS - PassengerPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating Passenger object", $e);
		}
	}
	...
	public function ensureConsistency()
	{
		...
		if ($this->aPassengerType !== null && $this->passenger_type_id !== $this->aPassengerType->getId()) {
			$this->aPassengerType = null;
		}
		if ($this->aRequester !== null && $this->requester_id !== $this->aRequester->getId()) {
			$this->aRequester = null;
		}
		if ($this->aPassengerIllnessCategory !== null && $this->passenger_illness_category_id !== $this->aPassengerIllnessCategory->getId()) {
			$this->aPassengerIllnessCategory = null;
		}
	} // ensureConsistency
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		if ($con === null) {
			$con = Propel::getConnection(PassengerPeer::DATABASE_NAME, Propel::CONNECTION_READ);
		}

		// We don't need to alter the object instance pool; we're just modifying this instance
		// already in the pool.

		$stmt = PassengerPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BasePassenger:delete:pre') as $callable)
    {
      ...
      if ($ret)
      {
		...
		if ($con === null) {
			$con = Propel::getConnection(PassengerPeer::DATABASE_NAME, Propel::CONNECTION_WRITE);
		}
		
		$con->beginTransaction();
		try {
			PassengerPeer::doDelete($this, $con);
    ...
    foreach (sfMixer::getCallables('BasePassenger:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BasePassenger:save:pre') as $callable)
    {
      ...
      if (is_int($affectedRows))
      {
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BasePassenger:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
    }

			PassengerPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->aPassengerType !== null) {
				if ($this->aPassengerType->isModified() || $this->aPassengerType->isNew()) {
					$affectedRows += $this->aPassengerType->save($con);
				}
				$this->setPassengerType($this->aPassengerType);
			}

			if ($this->aRequester !== null) {
				if ($this->aRequester->isModified() || $this->aRequester->isNew()) {
					$affectedRows += $this->aRequester->save($con);
				}
				$this->setRequester($this->aRequester);
			}

			if ($this->aPassengerIllnessCategory !== null) {
				if ($this->aPassengerIllnessCategory->isModified() || $this->aPassengerIllnessCategory->isNew()) {
					$affectedRows += $this->aPassengerIllnessCategory->save($con);
				}
				$this->setPassengerIllnessCategory($this->aPassengerIllnessCategory);
			}
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = PassengerPeer::doInsert($this, $con);
					...
					$affectedRows += PassengerPeer::doUpdate($this, $con);
				}
	...
	{
		$pos = PassengerPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 15:
				...
				break;
			case 16:
				return $this->getFacilityCity();
				break;
			case 17:
				return $this->getFacilityState();
				break;
			case 18:
	...
	{
		$keys = PassengerPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			...
			$keys[16] => $this->getFacilityCity(),
			$keys[17] => $this->getFacilityState(),
			$keys[18] => $this->getFacilityPhone(),
			$keys[19] => $this->getFacilityPhoneComment(),
			$keys[20] => $this->getRequesterId(),
			$keys[21] => $this->getMedicalReleaseRequested(),
			$keys[22] => $this->getMedicalReleaseReceived(),
			$keys[23] => $this->getPassengerIllnessCategoryId(),
			$keys[24] => $this->getReleasingFax1(),
			$keys[25] => $this->getReleasingFax1Comment(),
			$keys[26] => $this->getReleasingEmail(),
			$keys[27] => $this->getTreatingPhysician(),
			$keys[28] => $this->getTreatingPhone(),
			$keys[29] => $this->getTreatingFax1(),
			$keys[30] => $this->getTreatingFax1Comment(),
			$keys[31] => $this->getTreatingEmail(),
			$keys[32] => $this->getLanguageSpoken(),
			$keys[33] => $this->getBestContactMethod(),
			$keys[34] => $this->getEmergencyContactName(),
			$keys[35] => $this->getEmergencyContactPrimaryPhone(),
			$keys[36] => $this->getEmergencyContactSecondaryPhone(),
			$keys[37] => $this->getEmergencyContactPrimaryComment(),
			$keys[38] => $this->getEmergencyContactSecondaryComment(),
			$keys[39] => $this->getTravelHistoryNotes(),
			$keys[40] => $this->getNeedMedicalRelease(),
			$keys[41] => $this->getGroundTransportationComment(),
		);
		return $result;
	}
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 15:
				...
				break;
			case 16:
				$this->setFacilityCity($value);
				break;
			case 17:
				$this->setFacilityState($value);
				break;
			case 18:
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[16], $arr)) $this->setFacilityCity($arr[$keys[16]]);
		if (array_key_exists($keys[17], $arr)) $this->setFacilityState($arr[$keys[17]]);
		if (array_key_exists($keys[18], $arr)) $this->setFacilityPhone($arr[$keys[18]]);
		if (array_key_exists($keys[19], $arr)) $this->setFacilityPhoneComment($arr[$keys[19]]);
		if (array_key_exists($keys[20], $arr)) $this->setRequesterId($arr[$keys[20]]);
		if (array_key_exists($keys[21], $arr)) $this->setMedicalReleaseRequested($arr[$keys[21]]);
		if (array_key_exists($keys[22], $arr)) $this->setMedicalReleaseReceived($arr[$keys[22]]);
		if (array_key_exists($keys[23], $arr)) $this->setPassengerIllnessCategoryId($arr[$keys[23]]);
		if (array_key_exists($keys[24], $arr)) $this->setReleasingFax1($arr[$keys[24]]);
		if (array_key_exists($keys[25], $arr)) $this->setReleasingFax1Comment($arr[$keys[25]]);
		if (array_key_exists($keys[26], $arr)) $this->setReleasingEmail($arr[$keys[26]]);
		if (array_key_exists($keys[27], $arr)) $this->setTreatingPhysician($arr[$keys[27]]);
		if (array_key_exists($keys[28], $arr)) $this->setTreatingPhone($arr[$keys[28]]);
		if (array_key_exists($keys[29], $arr)) $this->setTreatingFax1($arr[$keys[29]]);
		if (array_key_exists($keys[30], $arr)) $this->setTreatingFax1Comment($arr[$keys[30]]);
		if (array_key_exists($keys[31], $arr)) $this->setTreatingEmail($arr[$keys[31]]);
		if (array_key_exists($keys[32], $arr)) $this->setLanguageSpoken($arr[$keys[32]]);
		if (array_key_exists($keys[33], $arr)) $this->setBestContactMethod($arr[$keys[33]]);
		if (array_key_exists($keys[34], $arr)) $this->setEmergencyContactName($arr[$keys[34]]);
		if (array_key_exists($keys[35], $arr)) $this->setEmergencyContactPrimaryPhone($arr[$keys[35]]);
		if (array_key_exists($keys[36], $arr)) $this->setEmergencyContactSecondaryPhone($arr[$keys[36]]);
		if (array_key_exists($keys[37], $arr)) $this->setEmergencyContactPrimaryComment($arr[$keys[37]]);
		if (array_key_exists($keys[38], $arr)) $this->setEmergencyContactSecondaryComment($arr[$keys[38]]);
		if (array_key_exists($keys[39], $arr)) $this->setTravelHistoryNotes($arr[$keys[39]]);
		if (array_key_exists($keys[40], $arr)) $this->setNeedMedicalRelease($arr[$keys[40]]);
		if (array_key_exists($keys[41], $arr)) $this->setGroundTransportationComment($arr[$keys[41]]);
	}
	...
	{
		$criteria = new Criteria(PassengerPeer::DATABASE_NAME);

		if ($this->isColumnModified(PassengerPeer::ID)) $criteria->add(PassengerPeer::ID, $this->id);
		if ($this->isColumnModified(PassengerPeer::PERSON_ID)) $criteria->add(PassengerPeer::PERSON_ID, $this->person_id);
		if ($this->isColumnModified(PassengerPeer::PASSENGER_TYPE_ID)) $criteria->add(PassengerPeer::PASSENGER_TYPE_ID, $this->passenger_type_id);
		if ($this->isColumnModified(PassengerPeer::PARENT)) $criteria->add(PassengerPeer::PARENT, $this->parent);
		if ($this->isColumnModified(PassengerPeer::DATE_OF_BIRTH)) $criteria->add(PassengerPeer::DATE_OF_BIRTH, $this->date_of_birth);
		if ($this->isColumnModified(PassengerPeer::ILLNESS)) $criteria->add(PassengerPeer::ILLNESS, $this->illness);
		if ($this->isColumnModified(PassengerPeer::FINANCIAL)) $criteria->add(PassengerPeer::FINANCIAL, $this->financial);
		if ($this->isColumnModified(PassengerPeer::WEIGHT)) $criteria->add(PassengerPeer::WEIGHT, $this->weight);
		if ($this->isColumnModified(PassengerPeer::PUBLIC_CONSIDERATIONS)) $criteria->add(PassengerPeer::PUBLIC_CONSIDERATIONS, $this->public_considerations);
		if ($this->isColumnModified(PassengerPeer::PRIVATE_CONSIDERATIONS)) $criteria->add(PassengerPeer::PRIVATE_CONSIDERATIONS, $this->private_considerations);
		if ($this->isColumnModified(PassengerPeer::RELEASING_PHYSICIAN)) $criteria->add(PassengerPeer::RELEASING_PHYSICIAN, $this->releasing_physician);
		if ($this->isColumnModified(PassengerPeer::RELEASING_PHONE)) $criteria->add(PassengerPeer::RELEASING_PHONE, $this->releasing_phone);
		if ($this->isColumnModified(PassengerPeer::LODGING_NAME)) $criteria->add(PassengerPeer::LODGING_NAME, $this->lodging_name);
		if ($this->isColumnModified(PassengerPeer::LODGING_PHONE)) $criteria->add(PassengerPeer::LODGING_PHONE, $this->lodging_phone);
		if ($this->isColumnModified(PassengerPeer::LODGING_PHONE_COMMENT)) $criteria->add(PassengerPeer::LODGING_PHONE_COMMENT, $this->lodging_phone_comment);
		if ($this->isColumnModified(PassengerPeer::FACILITY_NAME)) $criteria->add(PassengerPeer::FACILITY_NAME, $this->facility_name);
		if ($this->isColumnModified(PassengerPeer::FACILITY_CITY)) $criteria->add(PassengerPeer::FACILITY_CITY, $this->facility_city);
		if ($this->isColumnModified(PassengerPeer::FACILITY_STATE)) $criteria->add(PassengerPeer::FACILITY_STATE, $this->facility_state);
		if ($this->isColumnModified(PassengerPeer::FACILITY_PHONE)) $criteria->add(PassengerPeer::FACILITY_PHONE, $this->facility_phone);
		if ($this->isColumnModified(PassengerPeer::FACILITY_PHONE_COMMENT)) $criteria->add(PassengerPeer::FACILITY_PHONE_COMMENT, $this->facility_phone_comment);
		if ($this->isColumnModified(PassengerPeer::REQUESTER_ID)) $criteria->add(PassengerPeer::REQUESTER_ID, $this->requester_id);
		if ($this->isColumnModified(PassengerPeer::MEDICAL_RELEASE_REQUESTED)) $criteria->add(PassengerPeer::MEDICAL_RELEASE_REQUESTED, $this->medical_release_requested);
		if ($this->isColumnModified(PassengerPeer::MEDICAL_RELEASE_RECEIVED)) $criteria->add(PassengerPeer::MEDICAL_RELEASE_RECEIVED, $this->medical_release_received);
		if ($this->isColumnModified(PassengerPeer::PASSENGER_ILLNESS_CATEGORY_ID)) $criteria->add(PassengerPeer::PASSENGER_ILLNESS_CATEGORY_ID, $this->passenger_illness_category_id);
		if ($this->isColumnModified(PassengerPeer::RELEASING_FAX1)) $criteria->add(PassengerPeer::RELEASING_FAX1, $this->releasing_fax1);
		if ($this->isColumnModified(PassengerPeer::RELEASING_FAX1_COMMENT)) $criteria->add(PassengerPeer::RELEASING_FAX1_COMMENT, $this->releasing_fax1_comment);
		if ($this->isColumnModified(PassengerPeer::RELEASING_EMAIL)) $criteria->add(PassengerPeer::RELEASING_EMAIL, $this->releasing_email);
		if ($this->isColumnModified(PassengerPeer::TREATING_PHYSICIAN)) $criteria->add(PassengerPeer::TREATING_PHYSICIAN, $this->treating_physician);
		if ($this->isColumnModified(PassengerPeer::TREATING_PHONE)) $criteria->add(PassengerPeer::TREATING_PHONE, $this->treating_phone);
		if ($this->isColumnModified(PassengerPeer::TREATING_FAX1)) $criteria->add(PassengerPeer::TREATING_FAX1, $this->treating_fax1);
		if ($this->isColumnModified(PassengerPeer::TREATING_FAX1_COMMENT)) $criteria->add(PassengerPeer::TREATING_FAX1_COMMENT, $this->treating_fax1_comment);
		if ($this->isColumnModified(PassengerPeer::TREATING_EMAIL)) $criteria->add(PassengerPeer::TREATING_EMAIL, $this->treating_email);
		if ($this->isColumnModified(PassengerPeer::LANGUAGE_SPOKEN)) $criteria->add(PassengerPeer::LANGUAGE_SPOKEN, $this->language_spoken);
		if ($this->isColumnModified(PassengerPeer::BEST_CONTACT_METHOD)) $criteria->add(PassengerPeer::BEST_CONTACT_METHOD, $this->best_contact_method);
		if ($this->isColumnModified(PassengerPeer::EMERGENCY_CONTACT_NAME)) $criteria->add(PassengerPeer::EMERGENCY_CONTACT_NAME, $this->emergency_contact_name);
		if ($this->isColumnModified(PassengerPeer::EMERGENCY_CONTACT_PRIMARY_PHONE)) $criteria->add(PassengerPeer::EMERGENCY_CONTACT_PRIMARY_PHONE, $this->emergency_contact_primary_phone);
		if ($this->isColumnModified(PassengerPeer::EMERGENCY_CONTACT_SECONDARY_PHONE)) $criteria->add(PassengerPeer::EMERGENCY_CONTACT_SECONDARY_PHONE, $this->emergency_contact_secondary_phone);
		if ($this->isColumnModified(PassengerPeer::EMERGENCY_CONTACT_PRIMARY_COMMENT)) $criteria->add(PassengerPeer::EMERGENCY_CONTACT_PRIMARY_COMMENT, $this->emergency_contact_primary_comment);
		if ($this->isColumnModified(PassengerPeer::EMERGENCY_CONTACT_SECONDARY_COMMENT)) $criteria->add(PassengerPeer::EMERGENCY_CONTACT_SECONDARY_COMMENT, $this->emergency_contact_secondary_comment);
		if ($this->isColumnModified(PassengerPeer::TRAVEL_HISTORY_NOTES)) $criteria->add(PassengerPeer::TRAVEL_HISTORY_NOTES, $this->travel_history_notes);
		if ($this->isColumnModified(PassengerPeer::NEED_MEDICAL_RELEASE)) $criteria->add(PassengerPeer::NEED_MEDICAL_RELEASE, $this->need_medical_release);
		if ($this->isColumnModified(PassengerPeer::GROUND_TRANSPORTATION_COMMENT)) $criteria->add(PassengerPeer::GROUND_TRANSPORTATION_COMMENT, $this->ground_transportation_comment);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(PassengerPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Passenger (or compatible) type.
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setFacilityCity($this->facility_city);

		$copyObj->setFacilityState($this->facility_state);
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Passenger Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     PassengerPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new PassengerPeer();
		}
		return self::$peer;
	}
	...
	public function getPerson(PropelPDO $con = null)
	{
		if ($this->aPerson === null && ($this->person_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aPerson->addPassengers($this);
			 */
		}
		return $this->aPerson;
	}
	...
	/**
	 * Declares an association between this object and a PassengerType object.
	 *
	 * @param      PassengerType $v
	 * @return     Passenger The current object (for fluent API support)
	 * @throws     PropelException
	 */
	public function setPassengerType(PassengerType $v = null)
	{
		if ($v === null) {
			$this->setPassengerTypeId(NULL);
		} else {
			$this->setPassengerTypeId($v->getId());
		}

		$this->aPassengerType = $v;

		// Add binding for other direction of this n:n relationship.
		// If this object has already been added to the PassengerType object, it will not be re-added.
		if ($v !== null) {
			$v->addPassenger($this);
		}
	...
	/**
	 * Get the associated PassengerType object
	 *
	 * @param      PropelPDO Optional Connection object.
	 * @return     PassengerType The associated PassengerType object.
	 * @throws     PropelException
	 */
	public function getPassengerType(PropelPDO $con = null)
	{
		if ($this->aPassengerType === null && ($this->passenger_type_id !== null)) {
			$c = new Criteria(PassengerTypePeer::DATABASE_NAME);
			$c->add(PassengerTypePeer::ID, $this->passenger_type_id);
			$this->aPassengerType = PassengerTypePeer::doSelectOne($c, $con);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aPassengerType->addPassengers($this);
			 */
		}
		return $this->aPassengerType;
	}
	 ...
	 * @throws     PropelException
	 */
	public function setRequester(Requester $v = null)
	{
		if ($v === null) {
	 ...
	 * Otherwise if this Passenger has previously been saved, it will retrieve
	 * related CampPassengers from storage. If this Passenger is new, it will return
		...
		if ($this->collCampPassengers === null) {
			if ($this->isNew()) {
			   $this->collCampPassengers = array();
				...
				$criteria->add(CampPassengerPeer::PASSENGER_ID, $this->id);
	 ...
	 * Otherwise if this Passenger is new, it will return
	 * an empty collection; or if this Passenger has previously
	 * been saved, it will retrieve related CampPassengers from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in Passenger.
	 */
	public function getCampPassengersJoinCamp($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(PassengerPeer::DATABASE_NAME);
		}
		...
		if ($this->collCampPassengers === null) {
			if ($this->isNew()) {
				...
				$this->collCampPassengers = CampPassengerPeer::doSelectJoinCamp($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Passenger has previously been saved, it will retrieve
	 * related Companions from storage. If this Passenger is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collCompanions === null) {
			if ($this->isNew()) {
			   $this->collCompanions = array();
				...
				$criteria->add(CompanionPeer::PASSENGER_ID, $this->id);
	 ...
	 * actually need in Passenger.
	 */
	public function getCompanionsJoinPerson($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(PassengerPeer::DATABASE_NAME);
		}
		...
		if ($this->collCompanions === null) {
			if ($this->isNew()) {
				...
				$this->collCompanions = CompanionPeer::doSelectJoinPerson($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Passenger has previously been saved, it will retrieve
	 * related Missions from storage. If this Passenger is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collMissions === null) {
			if ($this->isNew()) {
			   $this->collMissions = array();
				...
				$criteria->add(MissionPeer::PASSENGER_ID, $this->id);
  ...
  {
    if (!$callable = sfMixer::getCallable('BasePassenger:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BasePassenger::%s', $method));
    }
