  ...
  const PEER = 'EmailTemplatePeer';
	...
	public function setSenderName($v)
	{
		...
		if ($this->sender_name !== $v) {
			$this->sender_name = $v;
			$this->modifiedColumns[] = EmailTemplatePeer::SENDER_NAME;
		}
	...
	public function setSenderEmail($v)
	{
		...
		if ($this->sender_email !== $v) {
			$this->sender_email = $v;
			$this->modifiedColumns[] = EmailTemplatePeer::SENDER_EMAIL;
		}
	...
	public function setPersonId($v)
	{
		...
		if ($this->person_id !== $v) {
			$this->person_id = $v;
			$this->modifiedColumns[] = EmailTemplatePeer::PERSON_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 7; // 7 = EmailTemplatePeer::NUM_COLUMNS - EmailTemplatePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(EmailTemplatePeer::SENDER_NAME)) $criteria->add(EmailTemplatePeer::SENDER_NAME, $this->sender_name);
		if ($this->isColumnModified(EmailTemplatePeer::SENDER_EMAIL)) $criteria->add(EmailTemplatePeer::SENDER_EMAIL, $this->sender_email);
		if ($this->isColumnModified(EmailTemplatePeer::BODY)) $criteria->add(EmailTemplatePeer::BODY, $this->body);
		if ($this->isColumnModified(EmailTemplatePeer::PERSON_ID)) $criteria->add(EmailTemplatePeer::PERSON_ID, $this->person_id);
	...
	public function getPerson(PropelPDO $con = null)
	{
		if ($this->aPerson === null && ($this->person_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aPerson->addEmailTemplates($this);
			 */
		}
		return $this->aPerson;
	}
