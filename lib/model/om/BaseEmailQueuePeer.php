...
abstract class BaseEmailQueuePeer {
	...
	const PERSON_ID = 'email_queue.PERSON_ID';

	/** the column name for the LETTER_ID field */
	const LETTER_ID = 'email_queue.LETTER_ID';

	/** the column name for the REQUEST_DATE field */
	const REQUEST_DATE = 'email_queue.REQUEST_DATE';

	/** the column name for the SEND_DATE field */
	const SEND_DATE = 'email_queue.SEND_DATE';

	/** the column name for the PRIORITY field */
	const PRIORITY = 'email_queue.PRIORITY';

	/** the column name for the SEND_STATUS field */
	const SEND_STATUS = 'email_queue.SEND_STATUS';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'PersonId', 'LetterId', 'RequestDate', 'SendDate', 'Priority', 'SendStatus', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'personId', 'letterId', 'requestDate', 'sendDate', 'priority', 'sendStatus', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::PERSON_ID, self::LETTER_ID, self::REQUEST_DATE, self::SEND_DATE, self::PRIORITY, self::SEND_STATUS, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'person_id', 'letter_id', 'request_date', 'send_date', 'priority', 'send_status', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'PersonId' => 1, 'LetterId' => 2, 'RequestDate' => 3, 'SendDate' => 4, 'Priority' => 5, 'SendStatus' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'personId' => 1, 'letterId' => 2, 'requestDate' => 3, 'sendDate' => 4, 'priority' => 5, 'sendStatus' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::PERSON_ID => 1, self::LETTER_ID => 2, self::REQUEST_DATE => 3, self::SEND_DATE => 4, self::PRIORITY => 5, self::SEND_STATUS => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'person_id' => 1, 'letter_id' => 2, 'request_date' => 3, 'send_date' => 4, 'priority' => 5, 'send_status' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(EmailQueuePeer::PERSON_ID);

		$criteria->addSelectColumn(EmailQueuePeer::LETTER_ID);

		$criteria->addSelectColumn(EmailQueuePeer::REQUEST_DATE);

		$criteria->addSelectColumn(EmailQueuePeer::SEND_DATE);

		$criteria->addSelectColumn(EmailQueuePeer::PRIORITY);

		$criteria->addSelectColumn(EmailQueuePeer::SEND_STATUS);
	...
	public static function doCountJoinPerson(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(EmailQueuePeer::PERSON_ID,), array(PersonPeer::ID,), $join_behavior);
	...
	public static function doCountJoinEmailLetter(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(EmailQueuePeer::LETTER_ID,), array(EmailLetterPeer::ID,), $join_behavior);
	...
	/**
	 * Selects a collection of EmailQueue objects pre-filled with their Person objects.
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    foreach (sfMixer::getCallables('BaseEmailQueuePeer:doSelectJoin:doSelectJoin') as $callable)
    {
      call_user_func($callable, 'BaseEmailQueuePeer', $c, $con);
		...
		$c->addJoin(array(EmailQueuePeer::PERSON_ID,), array(PersonPeer::ID,), $join_behavior);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (EmailQueue) to $obj2 (Person)
	...
	/**
	 * Selects a collection of EmailQueue objects pre-filled with their EmailLetter objects.
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of EmailQueue objects.
	...
	public static function doSelectJoinEmailLetter(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$c->addJoin(array(EmailQueuePeer::LETTER_ID,), array(EmailLetterPeer::ID,), $join_behavior);
		$stmt = BasePeer::doSelect($c, $con);
		$results = array();
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (EmailQueue) to $obj2 (EmailLetter)
				$obj2->addEmailQueue($obj1);
    ...
    foreach (sfMixer::getCallables('BaseEmailQueuePeer:doSelectJoinAll:doSelectJoinAll') as $callable)
    {
      call_user_func($callable, 'BaseEmailQueuePeer', $c, $con);
		...
		EmailLetterPeer::addSelectColumns($c);
		$startcol4 = $startcol3 + (EmailLetterPeer::NUM_COLUMNS - EmailLetterPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (EmailQueue) to the collection in $obj2 (Person)
				$obj2->addEmailQueue($obj1);
			} // if joined row not null

			// Add objects for joined EmailLetter rows

			$key3 = EmailLetterPeer::getPrimaryKeyHashFromRow($row, $startcol3);
			if ($key3 !== null) {
				$obj3 = EmailLetterPeer::getInstanceFromPool($key3);
				if (!$obj3) {
					...
					EmailLetterPeer::addInstanceToPool($obj3, $key3);
				} // if obj3 loaded

				// Add the $obj1 (EmailQueue) to the collection in $obj3 (EmailLetter)
				$obj3->addEmailQueue($obj1);
			} // if joined row not null
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinAllExceptEmailLetter(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		// we're going to modify criteria, so copy it first
		$criteria = clone $criteria;
	...
	/**
	 * Selects a collection of EmailQueue objects pre-filled with all related objects except Person.
	 *
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    foreach (sfMixer::getCallables('BaseEmailQueuePeer:doSelectJoinAllExcept:doSelectJoinAllExcept') as $callable)
    {
      call_user_func($callable, 'BaseEmailQueuePeer', $c, $con);
    }
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj1 = EmailQueuePeer::getInstanceFromPool($key1))) {
				...
				// Add the $obj1 (EmailQueue) to the collection in $obj2 (EmailLetter)
				$obj2->addEmailQueue($obj1);
	...
	/**
	 * Selects a collection of EmailQueue objects pre-filled with all related objects except EmailLetter.
	 *
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinAllExceptEmailLetter(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$c = clone $c;
