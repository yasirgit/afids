...
abstract class BasePolicyPeer {
	...
	const EFFECTIVE_DATE = 'policy.EFFECTIVE_DATE';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Description', 'EffectiveDate', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'description', 'effectiveDate', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::DESCRIPTION, self::EFFECTIVE_DATE, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'description', 'effective_date', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Description' => 1, 'EffectiveDate' => 2, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'description' => 1, 'effectiveDate' => 2, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::DESCRIPTION => 1, self::EFFECTIVE_DATE => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'description' => 1, 'effective_date' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(PolicyPeer::ID);

		$criteria->addSelectColumn(PolicyPeer::DESCRIPTION);

		$criteria->addSelectColumn(PolicyPeer::EFFECTIVE_DATE);
  ...
  static public function getUniqueColumnNames()
  {
    ...
    foreach (sfMixer::getCallables('BasePolicyPeer:doInsert:pre') as $callable)
    {
      ...
      if (false !== $ret)
      {
		...
		if ($criteria->containsKey(PolicyPeer::ID) && $criteria->keyContainsValue(PolicyPeer::ID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.PolicyPeer::ID.')');
		}
    ...
    foreach (sfMixer::getCallables('BasePolicyPeer:doUpdate:pre') as $callable)
    {
      ...
      if (false !== $ret)
      {
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(PolicyPeer::ID);
			$selectCriteria->add(PolicyPeer::ID, $criteria->remove(PolicyPeer::ID), $comparison);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(PolicyPeer::ID, (array) $values, Criteria::IN);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(PolicyPeer::DATABASE_NAME);
			$criteria->add(PolicyPeer::ID, $pks, Criteria::IN);
