...
abstract class BasePilot extends BaseObject  implements Persistent {
  ...
  const PEER = 'PilotPeer';
	...
	public function setMopActiveStatus($v)
	{
		...
		if ($this->mop_active_status !== $v || $v === 1) {
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(PilotPeer::MOP_ACTIVE_STATUS))) {
				return false;
			}

			if ($this->mop_active_status !== 1) {
				return false;
			}
