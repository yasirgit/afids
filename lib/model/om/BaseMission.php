...
abstract class BaseMission extends BaseObject  implements Persistent {
  ...
  const PEER = 'MissionPeer';
	...
	/**
	 * The value for the copied_mission field.
	 * @var        string
	 */
	protected $copied_mission;
	...
	/**
	 * Get the [copied_mission] column value.
	 * 
	 * @return     string
	 */
	public function getCopiedMission()
	{
		return $this->copied_mission;
	}
	...
	/**
	 * Set the value of [copied_mission] column.
	 * 
	 * @param      string $v new value
	 * @return     Mission The current object (for fluent API support)
	 */
	public function setCopiedMission($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->copied_mission !== $v) {
			$this->copied_mission = $v;
			$this->modifiedColumns[] = MissionPeer::COPIED_MISSION;
		}
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(MissionPeer::MISSION_COUNT,MissionPeer::B_WEIGHT,MissionPeer::CANCEL_MISSION))) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->copied_mission = ($row[$startcol + 27] !== null) ? (string) $row[$startcol + 27] : null;
			$this->resetModified();
			...
			return $startcol + 28; // 28 = MissionPeer::NUM_COLUMNS - MissionPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[27], $arr)) $this->setCopiedMission($arr[$keys[27]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(MissionPeer::COPIED_MISSION)) $criteria->add(MissionPeer::COPIED_MISSION, $this->copied_mission);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setCopiedMission($this->copied_mission);
