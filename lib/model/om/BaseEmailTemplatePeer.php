...
abstract class BaseEmailTemplatePeer {
	...
	const SENDER_NAME = 'email_template.SENDER_NAME';

	/** the column name for the SENDER_EMAIL field */
	const SENDER_EMAIL = 'email_template.SENDER_EMAIL';

	/** the column name for the BODY field */
	const BODY = 'email_template.BODY';

	/** the column name for the PERSON_ID field */
	const PERSON_ID = 'email_template.PERSON_ID';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'Subject', 'SenderName', 'SenderEmail', 'Body', 'PersonId', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'subject', 'senderName', 'senderEmail', 'body', 'personId', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NAME, self::SUBJECT, self::SENDER_NAME, self::SENDER_EMAIL, self::BODY, self::PERSON_ID, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'subject', 'sender_name', 'sender_email', 'body', 'person_id', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'Subject' => 2, 'SenderName' => 3, 'SenderEmail' => 4, 'Body' => 5, 'PersonId' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'subject' => 2, 'senderName' => 3, 'senderEmail' => 4, 'body' => 5, 'personId' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NAME => 1, self::SUBJECT => 2, self::SENDER_NAME => 3, self::SENDER_EMAIL => 4, self::BODY => 5, self::PERSON_ID => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'subject' => 2, 'sender_name' => 3, 'sender_email' => 4, 'body' => 5, 'person_id' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new EmailTemplateMapBuilder();
		}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(EmailTemplatePeer::SENDER_NAME);

		$criteria->addSelectColumn(EmailTemplatePeer::SENDER_EMAIL);

		$criteria->addSelectColumn(EmailTemplatePeer::BODY);

		$criteria->addSelectColumn(EmailTemplatePeer::PERSON_ID);
	...
	public static function doCountJoinPerson(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(EmailTemplatePeer::PERSON_ID,), array(PersonPeer::ID,), $join_behavior);
	...
	/**
	 * Selects a collection of EmailTemplate objects pre-filled with their Person objects.
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of EmailTemplate objects.
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 */
    ...
    foreach (sfMixer::getCallables('BaseEmailTemplatePeer:doSelectJoin:doSelectJoin') as $callable)
    {
      call_user_func($callable, 'BaseEmailTemplatePeer', $c, $con);
		...
		$c->addJoin(array(EmailTemplatePeer::PERSON_ID,), array(PersonPeer::ID,), $join_behavior);
		$stmt = BasePeer::doSelect($c, $con);
		$results = array();

		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			$key1 = EmailTemplatePeer::getPrimaryKeyHashFromRow($row, 0);
			if (null !== ($obj1 = EmailTemplatePeer::getInstanceFromPool($key1))) {
				// We no longer rehydrate the object, since this can cause data loss.
				// See http://propel.phpdb.org/trac/ticket/509
				...
				$obj1 = new $cls();
				$obj1->hydrate($row);
				EmailTemplatePeer::addInstanceToPool($obj1, $key1);
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (EmailTemplate) to $obj2 (Person)
	...
	/**
	 * Selects a collection of EmailTemplate objects pre-filled with all related objects.
	 *
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    foreach (sfMixer::getCallables('BaseEmailTemplatePeer:doSelectJoinAll:doSelectJoinAll') as $callable)
    {
      call_user_func($callable, 'BaseEmailTemplatePeer', $c, $con);
    }
		...
		EmailTemplatePeer::addSelectColumns($c);
		$startcol2 = (EmailTemplatePeer::NUM_COLUMNS - EmailTemplatePeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (EmailTemplate) to the collection in $obj2 (Person)
				$obj2->addEmailTemplate($obj1);
  ...
  static public function getUniqueColumnNames()
  {
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		} elseif ($values instanceof EmailTemplate) {
...
//
// NOTE: This static code cannot call methods on the EmailTemplatePeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the EmailTemplatePeer class:
//
// Propel::getDatabaseMap(EmailTemplatePeer::DATABASE_NAME)->addTableBuilder(EmailTemplatePeer::TABLE_NAME, EmailTemplatePeer::getMapBuilder());
//
// Doing so will effectively overwrite the registration below.

Propel::getDatabaseMap(BaseEmailTemplatePeer::DATABASE_NAME)->addTableBuilder(BaseEmailTemplatePeer::TABLE_NAME, BaseEmailTemplatePeer::getMapBuilder());
