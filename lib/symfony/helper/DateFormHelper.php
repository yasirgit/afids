...
////////////////////////////////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////////////////
function select_month_tag_miga($name, $value = null, $options = array(), $html_options = array())
{
  if ($value === null)
  {
    $value = date('n');
...
function select_year_tag_miga($name, $value = null, $options = array(), $html_options = array())
{
  if ($value === null)
  {
    $value = date('Y');
  ...
  $year_start = _get_option($options, 'year_start', $year_origin);
  $year_end   = _get_option($options, 'year_end', $year_origin + 6);
