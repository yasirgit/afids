...
/**
 * ItineraryBackup filter form base class.
 *
 * @package    angelflight
 * @subpackage filter
 ...
 */
class BaseItineraryBackupFormFilter extends BaseFormFilterPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'mission_request_id'   => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'mission_request_id'   => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
    ...
    $this->widgetSchema->setNameFormat('itinerary_backup_filters[%s]');
