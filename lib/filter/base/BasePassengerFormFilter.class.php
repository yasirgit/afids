...
class BasePassengerFormFilter extends BaseFormFilterPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'camp_passenger_list'                 => new sfWidgetFormPropelChoice(array('model' => 'Camp', 'add_empty' => true)),
    ));
    ...
    $this->setValidators(array(
      ...
      'camp_passenger_list'                 => new sfValidatorPropelChoice(array('model' => 'Camp', 'required' => false)),
    ));
  ...
  public function addCampPassengerListColumnCriteria(Criteria $criteria, $field, $values)
  {
    ...
    $criteria->addJoin(CampPassengerPeer::PASSENGER_ID, PassengerPeer::ID);

    $value = array_pop($values);
    $criterion = $criteria->getNewCriterion(CampPassengerPeer::CAMP_ID, $value);

    foreach ($values as $value)
    {
      $criterion->addOr($criteria->getNewCriterion(CampPassengerPeer::CAMP_ID, $value));
    }
