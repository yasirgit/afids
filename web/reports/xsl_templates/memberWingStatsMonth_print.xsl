...
<table style="width:500px; border-collapse:collapse; margin:8px 0 0;" border="1" cellpadding="2" bordercolor="#a6bee0">
	<thead>
  	<tr>
		<td style="color:#153f7a;font-weight:bold;height:24px" bgcolor="#cfe1fc" width="180" align="left">Wing</td>
		<td style="color:#153f7a;font-weight:bold;height:24px" bgcolor="#cfe1fc" width="80" align="right">Non-Pilot</td>
		<td style="color:#153f7a;font-weight:bold;height:24px" bgcolor="#cfe1fc" width="80" align="right">Verify Orientation</td>
		<td style="color:#153f7a;font-weight:bold;height:24px" bgcolor="#cfe1fc" width="80" align="right">Command Pilot</td>
		<td style="color:#153f7a;font-weight:bold;height:24px" bgcolor="#cfe1fc" width="80" align="right">Total</td>
	</tr>
	</thead>
	<tbody>
...
<xsl:choose>
 	...
 	<tr>
		<td style="height:24px;" align="left" valign="top" width="180">
			<xsl:value-of select="wingName"/>
		</td>
		<td style="height:24px;" align="right" valign="top" width="80">
 	...
 	<tr>
		<td style="color:#153f7a;font-weight:bold;height:24px" bgcolor="#cfe1fc" align="left" valign="top" width="180">Totals
		</td>
		<td style="color:#153f7a;font-weight:bold;height:24px" bgcolor="#cfe1fc" align="right" valign="top" width="80"><b>
