...
<table style="width:500px; border-collapse:collapse; margin:8px 0 0;" border="1" cellpadding="2" bordercolor="#a6bee0">
	<thead>
    	<tr>
      	<td style="color:#153f7a;font-weight:bold;height:24px" bgcolor="#cfe1fc" width="150" align="left">Month</td>
        <td style="color:#153f7a;font-weight:bold;height:24px" bgcolor="#cfe1fc" width="58" align="right">Normal</td>
        <td style="color:#153f7a;font-weight:bold;height:24px" bgcolor="#cfe1fc" width="58" align="right">Transplant</td>
        <td style="color:#153f7a;font-weight:bold;height:24px" bgcolor="#cfe1fc" width="58" align="right">Admin</td>
        <td style="color:#153f7a;font-weight:bold;height:24px" bgcolor="#cfe1fc" width="58" align="right">Compassion</td>
        <td style="color:#153f7a;font-weight:bold;height:24px" bgcolor="#cfe1fc" width="58" align="right">Commercial Companion</td>
        <td style="color:#153f7a;font-weight:bold;height:24px" bgcolor="#cfe1fc" width="58" align="right">Disaster Response</td>
      </tr>
    </thead>
    <tbody>
