...
<table style="width:760px; border-collapse:collapse; margin:8px 0 0;" border="1" cellpadding="2" bordercolor="#a6bee0" width="760">
	<thead>
	<tr>
		<th style="color:#153f7a;font-weight:bold;height:24" bgcolor="#cfe1fc" width="150" valign="top" align="left">Photo</th>
		<th style="color:#153f7a;font-weight:bold;height:24" bgcolor="#cfe1fc" width="225" valign="top" align="left">Mission Date/Submission Date</th>
		<th style="color:#153f7a;font-weight:bold;height:24" bgcolor="#cfe1fc" width="225" valign="top" align="left">Passenger/Pilot</th>
		<th style="color:#153f7a;font-weight:bold;height:24" bgcolor="#cfe1fc" width="160" valign="top" align="left">Quality</th>
	</tr>
  </thead>
  <tbody>
		...
		<td align="left" valign="top" width="150">
			<a target="_new">
				<xsl:attribute name="href">
					<xsl:value-of select="concat('http://afids.angelflightwest.org/mission_photos/',photofilename)"/>
				</xsl:attribute>
				<img border="0">
