...
<table border="0" cellpadding="2" width="760" cellspacing="0">
    ...
    <tr nobr="true">
        <td width="25%"><strong>Mission #: </strong><xsl:value-of select=".//externalID"/></td>
        <td width="50%" align="center"><b><u>Mission Itinerary</u></b></td>
        <td width="25%"><strong>Date: </strong><xsl:value-of select=".//Now"/></td>
      </tr>
    <tr nobr="true">
    ...
    <table border="0" cellpadding="2" width="760" cellspacing="0">
      <tr nobr="true">
        <td width="50%" align="left"><strong>MISSION DATE: </strong><xsl:value-of select=".//missionDate"/></td>
...
<xsl:for-each select=".//record">
    ...
    <table border="0" cellpadding="2" width="760" cellspacing="0" nobr="true">
      <tr nobr="true">
...
<!-- companions table -->
<table border="0" bordercolor="red" nobr="true"><tr nobr="true"><td>
<table border="1" cellpadding="4" width="760" cellspacing="0" nobr="true">
<tr nobr="true">
	<td colspan="5">
		<strong>
...
<tr nobr="true">
	<td width="35%" valign="top" align="left"><strong>Companion name</strong></td>
  <td width="35%" valign="top" align="left"><strong>Relationship</strong></td>
  <td width="7%" valign="top" align="left"><strong>DOB</strong></td>
  <td width="7%" valign="top" align="left"><strong>Weight</strong></td>
  <td width="15%" valign="top" align="left"><strong>Phone</strong></td>
</tr>
<xsl:if test=".//companionName!=''">
<xsl:for-each select=".//record">
   <xsl:if test="not(preceding-sibling::node()[companionName = current()/companionName])">
			<tr nobr="true">
        <td width="35%" valign="top" align="left"><xsl:value-of select="companionName"/><xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text></td>
        <td width="35%" valign="top" align="left"><xsl:value-of select="relationship"/><xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text></td>
      ...
      <tr nobr="true">
        <td width="78%" colspan="3" valign="top" align="left"><strong>Baggage: </strong><xsl:value-of select=".//baggageDesc"/></td>
        <td width="7%" valign="top" align="left"><xsl:value-of select="number(.//baggageWeight)"/></td>
        <td width="15%"><xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text></td>
      </tr>
      <tr nobr="true">
        <td width="78%" valign="top" align="right"><strong>Total Mission Weight (passenger, companion(s), baggage): </strong></td>
        <td width="7%" valign="top" align="left"><xsl:value-of select="number(.//baggageWeight) + number(.//passWeight) + sum(//record[legNumber = '1']/companionWeight)"/></td>
        <td width="15%"><xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text></td>
      </tr>
</table>
</td></tr></table>
...
<tr><td colspan="4"><hr/></td></tr>
      ...
      <tr nobr="true">
        <td width="25%" valign="top" align="right"><strong>Pub. Cons.:</strong></td>
        <td valign="top" align="left" width="75%"><xsl:value-of select=".//publicConsiderations"/></td>
      </tr>
      </xsl:if>
      <xsl:if test=".//privateConsiderations!=''">
      <tr nobr="true">
        <td width="25%" valign="top" align="right"><strong>Priv. Cons.:</strong></td>
        <td valign="top" align="left" width="75%"><xsl:value-of select=".//privateConsiderations"/></td>
      </tr>
      </xsl:if>
      <xsl:if test=".//comment!=''">
      <tr nobr="true">
        <td width="25%" valign="top" align="right"><strong>Comments:</strong></td>
        <td valign="top" align="left" width="75%"><xsl:value-of select=".//comment"/></td>
      </tr>
      </xsl:if>
      <xsl:if test=".//missionSpecificComments!=''">
      <tr nobr="true">
        <td width="25%" valign="top" align="right"><strong>Mission Comments:</strong></td>
        <td valign="top" align="left" width="75%"><xsl:value-of select=".//missionSpecificComments"/></td>
      </tr>
      </xsl:if>
      <xsl:if test=".//groundTransportationComment!=''">
      <tr nobr="true">
        <td width="25%" valign="top" align="right"><strong>Ground Xport:</strong></td>
        <td width="85%" valign="top" align="left" colspan="3"><xsl:value-of select=".//groundTransportationComment"/></td>
      </tr>
      </xsl:if>
    </table>
