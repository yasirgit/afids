...
<table style="border-collapse:collapse; margin:8px 0 0;" border="1" cellpadding="2" bordercolor="#a6bee0" width="760">
	<thead>
	<tr>
		<th style="color:#153f7a;font-weight:bold;height:24px" bgcolor="#cfe1fc" align="left" width="120">Mission</th>
		<th style="color:#153f7a;font-weight:bold;height:24px" bgcolor="#cfe1fc" align="left" width="190">Pilot</th>
		<th style="color:#153f7a;font-weight:bold;height:24px" bgcolor="#cfe1fc" align="left" width="225">Passenger</th>
		<th style="color:#153f7a;font-weight:bold;height:24px" bgcolor="#cfe1fc" align="left" width="225">Agency</th>
	</tr>
	</thead>
	<tbody>
	<xsl:for-each select=".//record">
    <tr nobr="true">
		<td style="height:24px" align="left" valign="top" width="120">
		...
		<td style="height:24px" width="190" align="left" valign="top">
			<xsl:value-of select="pilotName"/>
			<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
		</td>
		<td style="height:24px" width="225" align="left" valign="top">
