	...
	<li>
  	<a>
			<xsl:attribute name="href">
				<xsl:call-template name="make-legs-link"/>
			</xsl:attribute>
  ...
  <xsl:when test="not(preceding-sibling::node()[monthNo = current()/monthNo])">
 	<tr>
		...
		<td align="right" valign="top" width="100">
			<xsl:value-of select="format-number(sum(/afids_report/record[missionTypeID=1][monthNo=current()/monthNo]/commercialCost),'$#,###.00')"/>
			<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
		</td>
		<td align="right" valign="top" width="100">
			<xsl:value-of select="format-number(sum(/afids_report/record[missionTypeID=3][monthNo=current()/monthNo]/commercialCost),'$#,###.00')"/>
			<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
		</td>
		<td align="right" valign="top" width="100">
			<xsl:value-of select="format-number(sum(/afids_report/record[missionTypeID=2][monthNo=current()/monthNo]/commercialCost),'$#,###.00')"/>
			<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
		</td>
		<td align="right" valign="top" width="100">
			<xsl:value-of select="format-number(sum(/afids_report/record[missionTypeID=4][monthNo=current()/monthNo]/commercialCost),'$#,###.00')"/>
			<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
		</td>
		<td align="right" valign="top" width="100">
			<xsl:value-of select="format-number(sum(/afids_report/record[missionTypeID=5][monthNo=current()/monthNo]/commercialCost),'$#,###.00')"/>
			<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
		</td>
		<td align="right" valign="top" width="100">
			<xsl:value-of select="format-number(sum(/afids_report/record[missionTypeID=6][monthNo=current()/monthNo]/commercialCost),'$#,###.00')"/>
			<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
		</td>
	</tr>
</xsl:when>
 	...
 	<tr>
		...
		<td align="right" valign="top" width="100"><b>
			<xsl:value-of select="format-number(sum(/afids_report/record[missionTypeID=1]/commercialCost),'$#,###.00')"/>
			<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text></b>
		</td>
		<td align="right" valign="top" width="100"><b>
			<xsl:value-of select="format-number(sum(/afids_report/record[missionTypeID=3]/commercialCost),'$#,###.00')"/>
			<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text></b>
		</td>
		<td align="right" valign="top" width="100"><b>
			<xsl:value-of select="format-number(sum(/afids_report/record[missionTypeID=2]/commercialCost),'$#,###.00')"/>
			<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text></b>
		</td>
		<td align="right" valign="top" width="100"><b>
			<xsl:value-of select="format-number(sum(/afids_report/record[missionTypeID=4]/commercialCost),'$#,###.00')"/>
			<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text></b>
		</td>
		<td align="right" valign="top" width="100"><b>
			<xsl:value-of select="format-number(sum(/afids_report/record[missionTypeID=5]/commercialCost),'$#,###.00')"/>
			<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text></b>
		</td>
		<td align="right" valign="top" width="100"><b>
			<xsl:value-of select="format-number(sum(/afids_report/record[missionTypeID=6]/commercialCost),'$#,###.00')"/>
			<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text></b>
		</td>
	</tr>
	</tbody>
...
<xsl:template name="make-legs-link">
	<xsl:value-of select="concat('reports.php?reportDef=','report_specs.xml')" /><xsl:text disable-output-escaping="yes">&amp;</xsl:text>
	<xsl:value-of select="concat('reportName=','missionTypeWingStatsLeg')" /><xsl:text disable-output-escaping="yes">&amp;</xsl:text>
	<xsl:value-of select="concat('action=','display')" /><xsl:text disable-output-escaping="yes">&amp;</xsl:text>
	<xsl:for-each select="//params/param">
	   <xsl:value-of select="concat(@field,'=',@value)"/><xsl:text disable-output-escaping="yes">&amp;</xsl:text>
	</xsl:for-each>
