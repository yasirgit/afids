...
<xsl:choose>
 	...
 	<tr>
		...
		<td align="right" valign="top" width="100">
			<xsl:value-of select="format-number(sum(/afids_report/record[missionTypeID=1][monthNo=current()/monthNo]/aircraftCost),'$#,###.00')"/>
			<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
		</td>
		<td align="right" valign="top" width="100">
			<xsl:value-of select="format-number(sum(/afids_report/record[missionTypeID=3][monthNo=current()/monthNo]/aircraftCost),'$#,###.00')"/>
			<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
		</td>
		<td align="right" valign="top" width="100">
			<xsl:value-of select="format-number(sum(/afids_report/record[missionTypeID=2][monthNo=current()/monthNo]/aircraftCost),'$#,###.00')"/>
			<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
		</td>
		<td align="right" valign="top" width="100">
			<xsl:value-of select="format-number(sum(/afids_report/record[missionTypeID=4][monthNo=current()/monthNo]/aircraftCost),'$#,###.00')"/>
			<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
		</td>
		<td align="right" valign="top" width="100">
			<xsl:value-of select="format-number(sum(/afids_report/record[missionTypeID=5][monthNo=current()/monthNo]/aircraftCost),'$#,###.00')"/>
			<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
		</td>
		<td align="right" valign="top" width="100">
			<xsl:value-of select="format-number(sum(/afids_report/record[missionTypeID=6][monthNo=current()/monthNo]/aircraftCost),'$#,###.00')"/>
			<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
		</td>
	</tr>
</xsl:when>
 	...
 	<tr>
		...
		<td align="right" valign="top" width="100"><b>
			<xsl:value-of select="format-number(sum(/afids_report/record[missionTypeID=1]/aircraftCost),'$#,###.00')"/>
			<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text></b>
		</td>
		<td align="right" valign="top" width="100"><b>
			<xsl:value-of select="format-number(sum(/afids_report/record[missionTypeID=3]/aircraftCost),'$#,###.00')"/>
			<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text></b>
		</td>
		<td align="right" valign="top" width="100"><b>
			<xsl:value-of select="format-number(sum(/afids_report/record[missionTypeID=2]/aircraftCost),'$#,###.00')"/>
			<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text></b>
		</td>
		<td align="right" valign="top" width="100"><b>
			<xsl:value-of select="format-number(sum(/afids_report/record[missionTypeID=4]/aircraftCost),'$#,###.00')"/>
			<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text></b>
		</td>
		<td align="right" valign="top" width="100"><b>
			<xsl:value-of select="format-number(sum(/afids_report/record[missionTypeID=5]/aircraftCost),'$#,###.00')"/>
			<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text></b>
		</td>
		<td align="right" valign="top" width="100"><b>
			<xsl:value-of select="format-number(sum(/afids_report/record[missionTypeID=6]/aircraftCost),'$#,###.00')"/>
			<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text></b>
		</td>
	</tr>
	</tbody>
