...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => '/opt/httpd-builtin-2.2.0/afids/log/frontend_dev.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/opt/httpd-builtin-2.2.0/afids/cache/frontend/dev/i18n',
  'lifetime' => 31556926,
  'prefix' => '/opt/httpd-builtin-2.2.0/afids/apps/frontend/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/opt/httpd-builtin-2.2.0/afids/cache/frontend/dev/template',
  'lifetime' => 86400,
  'prefix' => '/opt/httpd-builtin-2.2.0/afids/apps/frontend/template',
)));
