...
<div class="step" style="display: block;">
   <?php echo javascript_tag("
      jQuery(document).ready(function(){
            $('div.steps-area div.step-list ul li').each(function(index){               
                 jQuery(this).unbind('click');               
            });
      });");
   ?>
<div class="passenger-form">Complete the fields below as the data
appears on the pilot application.
<form
	action="<?php echo url_for('pending_member/step1Check'.(!$form->getObject()->isNew() ? '?id='.$form->getObject()->getId() : '')) ?>"
	method="post"
	<?php $form->isMultipart() and print 'enctype="multipart/form-data" ' ?>>
	<?php echo $form->renderHiddenFields() ?>
<div class="box">
<div class="wrap"><?php echo $form['title']->renderLabel() ?> <?php echo $form['title'] ?>
	<?php echo $form['title']->renderError() ?></div>
<div class="wrap"><?php echo $form['first_name']->renderLabel() ?> <?php echo $form['first_name'] ?>
	<?php echo $form['first_name']->renderError() ?></div>
<div class="wrap"><?php echo $form['middle_name']->renderLabel() ?> <?php echo $form['middle_name'] ?>
	<?php echo $form['middle_name']->renderError() ?></div>
<div class="wrap"><?php echo $form['last_name']->renderLabel() ?> <?php echo $form['last_name'] ?>
	<?php echo $form['last_name']->renderError() ?></div>
<div class="wrap"><?php echo $form['suffix']->renderLabel() ?> <?php echo $form['suffix'] ?>
	<?php echo $form['suffix']->renderError() ?></div>
<div class="wrap"><?php echo $form['nickname']->renderLabel() ?> <?php echo $form['nickname'] ?>
	<?php echo $form['nickname']->renderError() ?></div>
...
<?php echo $form['day_phone']->renderError() ?></div>
...
<?php echo $form['eve_comment']->renderError() ?></div>
...
<?php echo $form['mobile_comment']->renderError() ?></div>
...
<?php echo $form['pager_comment']->renderError() ?></div>
...
<?php echo $form['fax_comment1']->renderError() ?></div>
...
<?php echo $form['fax_comment2']->renderError() ?></div>
...
<?php echo $form['other_comment']->renderError() ?></div>
<div class="wrap"><?php echo $form['pager_email']->renderLabel() ?> <?php echo $form['pager_email'] ?>
<?php echo $form['pager_email']->renderError() ?></div>
...
<div class="wrap"><label><?php echo $form['applicant_pilot']->renderLabelName() ?></label>
<div class="wrap"><?php echo $form['applicant_pilot'] ?> <?php echo $form['applicant_pilot']->renderError() ?>
<?php echo $form['applicant_pilot']->renderHelp() ?></div>
</div>
<div class="form-submit"><a class="btn-action" href="#"
	onclick="$('#step1_submit').click(); return false;"><span>Save and
Continue »</span><strong> </strong></a> <?php echo link_to("Cancel", "/dashboard/index", array("class" => "cancel"));?>
