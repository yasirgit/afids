...
<form method="post" action="<?php echo url_for('email/emailBulkQueue')?>" enctype="multipart/form-data">
  <div class="passenger-form">
    <div class="box full">
      <div class="wrap">
        <label for="recipients">To</label>
        <a href="#" id="select_from_list" >select from list</a>
      ...
      <div class="wrap">
        ...
        <div class="wrap">
          ...
          <input type="file" name="attachment[]" id="attachment2" style="clear:left; display: none;"/>
          <input type="file" name="attachment[]" id="attachment3" style="clear:left; display: none;"/>
          <input type="file" name="attachment[]" id="attachment4" style="clear:left; display: none;"/>
          <input type="file" name="attachment[]" id="attachment5" style="clear:left; display: none;"/>
          <br clear="all"/>
          <?php if(isset($attachement_error)):?>
          <span class="error_list"><?php echo $attachement_error?></span>
          <?php endif;?>
          <span id="attachment_message" style="display: none;">You can attach up to 5 files</span>
      ...
      <div class="wrap">
        ...
        <div class="wrap">
            <?php echo input_tag('send_date', isset($send_date)?$send_date:'', array('rich'=>true,'withtime'=>true)); ?>
            <script type="text/javascript">
            $(function() {
            	   $('#send_date').datetimepicker();
            });
            </script>
            <?php if (isset($errors['send_date'])) {?>
                    <ul class="error_list">
                      <li><?php echo $errors['send_date']?></li>
                    </ul>
        <?php }?>
        </div>
      </div>
      <div class="wrap">
        ...
        <div class="wrap">
          <?php echo select_tag('priority', options_for_select(array('None','Low','Medium','High'), isset($priority)?$priority:'')) ?>
         </div>
      </div>
      <div class="form-submit">
        <a class="btn-action" href="#" onclick="$('#form_submit').click();return false;"><span>Queue Bulk Email &raquo;</span><strong> </strong></a>
