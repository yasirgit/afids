...
<div class="person-view">
  ...
  <table class="form-table">
    ...
    <tr>
      <th>Address</th>
      <td>
        <?php if ($application_temp->getAddress1().$application_temp->getAddress2()) {?>
          <?php echo $application_temp->getAddress1().'<br/>'.$application_temp->getAddress2()?>
        <?php }else echo '--'?>
      </td>
      <th>Phone(s)</th>
      <td>
        <?php if ($v = $application_temp->getDayPhone()) echo 'Day: '.$v?><br/>
    ...
    <tr>
      <th>Spouse Name</th>
      <td colspan="3">
        <?php if ($application_temp->getSpouseFirstName().$application_temp->getSpouseLastName()) { ?>
    ...
    <tr>
      <th>Referral</th>
      <td colspan="3">
        <?php $ref = $application_temp->getReferralSource()?>
        <?php if ($ref) $v = $ref->getName().'<br/>'; else $v = ''?>
        <?php $v .= $application_temp->getReferralSourceOther()?>
        <?php echo $v ? $v : '--'?>
      </td>
    </tr>
    <tr>
  ...
  <table class="form-table">
    ...
    <tr>
      ...
      <th>Other Hours</th>
      <td>
        <?php echo $application_temp->getOtherHours()?>
        <b>IFR:</b> <?php echo $application_temp->getIfrHours()?>
        <b>Multi:</b> <?php echo $application_temp->getMultiHours()?>
      </td>
    </tr>
    <tr>
      <th>Ratings</th>
  ...
  <fieldset style="border-style: ridge;">
    <legend><b>Aircraft</b></legend>
  ...
  <fieldset style="border-style: ridge;">
    ...
    <table>
      <tr>
        <td>
          Mission orientation: <?php echo $application_temp->getMissionOrientation() ? 'Yes' : 'No'?><br/>
        ...
        <td>
          Telephone: <?php echo $application_temp->getTelephoneWork() ? 'Yes' : 'No'?><br/>
        ...
        <td>
          Graphic arts: <?php echo $application_temp->getGraphicArts() ? 'Yes' : 'No'?><br/>
