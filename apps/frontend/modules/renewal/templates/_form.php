...
<form action="<?php echo url_for('renewal/'.($form->getObject()->isNew() ? 'create' : 'update').(!$form->getObject()->isNew() ? '?id='.$form->getObject()->getId() : '')) ?>" method="post" <?php $form->isMultipart() and print 'enctype="multipart/form-data" ' ?>>
  ...
  <table>
    <tfoot>
      <tr>
        <td colspan="2">
          ...
          &nbsp;<a href="<?php echo url_for('renewal/index') ?>">Cancel</a>
          <?php if (!$form->getObject()->isNew()): ?>
            &nbsp;<?php echo link_to('Delete', 'renewal/delete?id='.$form->getObject()->getId(), array('method' => 'delete', 'confirm' => 'Are you sure?')) ?>
          <?php endif; ?>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <?php echo $form['application_date']->renderError() ?>
          <?php echo $form['application_date'] ?>
        </td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td>
          <?php echo $form['applicant_copilot']->renderError() ?>
          <?php echo $form['applicant_copilot'] ?>
        </td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td>
          <?php echo $form['fbo_name']->renderError() ?>
          <?php echo $form['fbo_name'] ?>
        </td>
      </tr>
      <tr>
        <th><?php echo $form['aircraft_primary_id']->renderLabel() ?></th>
        <td>
          <?php echo $form['aircraft_primary_id']->renderError() ?>
          <?php echo $form['aircraft_primary_id'] ?>
        </td>
      </tr>
      <tr>
        <th><?php echo $form['aircraft_primary_own']->renderLabel() ?></th>
        <td>
          <?php echo $form['aircraft_primary_own']->renderError() ?>
          <?php echo $form['aircraft_primary_own'] ?>
        </td>
      </tr>
      <tr>
        <th><?php echo $form['aircraft_primary_ice']->renderLabel() ?></th>
        <td>
          <?php echo $form['aircraft_primary_ice']->renderError() ?>
          <?php echo $form['aircraft_primary_ice'] ?>
        </td>
      </tr>
      <tr>
        <th><?php echo $form['aircraft_primary_seats']->renderLabel() ?></th>
        <td>
          <?php echo $form['aircraft_primary_seats']->renderError() ?>
          <?php echo $form['aircraft_primary_seats'] ?>
        </td>
      </tr>
      <tr>
        <th><?php echo $form['aircraft_primary_n_number']->renderLabel() ?></th>
        <td>
          <?php echo $form['aircraft_primary_n_number']->renderError() ?>
          <?php echo $form['aircraft_primary_n_number'] ?>
        </td>
      </tr>
      <tr>
        <th><?php echo $form['aircraft_secondary_id']->renderLabel() ?></th>
        <td>
          <?php echo $form['aircraft_secondary_id']->renderError() ?>
          <?php echo $form['aircraft_secondary_id'] ?>
        </td>
      </tr>
      <tr>
        <th><?php echo $form['aircraft_secondary_own']->renderLabel() ?></th>
        <td>
          <?php echo $form['aircraft_secondary_own']->renderError() ?>
          <?php echo $form['aircraft_secondary_own'] ?>
        </td>
      </tr>
      <tr>
        <th><?php echo $form['aircraft_secondary_ice']->renderLabel() ?></th>
        <td>
          <?php echo $form['aircraft_secondary_ice']->renderError() ?>
          <?php echo $form['aircraft_secondary_ice'] ?>
        </td>
      </tr>
      <tr>
        <th><?php echo $form['aircraft_secondary_seats']->renderLabel() ?></th>
        <td>
          <?php echo $form['aircraft_secondary_seats']->renderError() ?>
          <?php echo $form['aircraft_secondary_seats'] ?>
        </td>
      </tr>
      <tr>
        <th><?php echo $form['aircraft_secondary_n_number']->renderLabel() ?></th>
        <td>
          <?php echo $form['aircraft_secondary_n_number']->renderError() ?>
          <?php echo $form['aircraft_secondary_n_number'] ?>
        </td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td>
          <?php echo $form['ratings']->renderError() ?>
          <?php echo $form['ratings'] ?>
        </td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td>
          <?php echo $form['availability_weekdays']->renderError() ?>
          <?php echo $form['availability_weekdays'] ?>
        </td>
      </tr>
      <tr>
        <th><?php echo $form['availability_weeknights']->renderLabel() ?></th>
        <td>
          <?php echo $form['availability_weeknights']->renderError() ?>
          <?php echo $form['availability_weeknights'] ?>
        </td>
      </tr>
      <tr>
        <th><?php echo $form['availability_weekends']->renderLabel() ?></th>
        <td>
          <?php echo $form['availability_weekends']->renderError() ?>
          <?php echo $form['availability_weekends'] ?>
        </td>
      </tr>
      <tr>
        <th><?php echo $form['availability_notice']->renderLabel() ?></th>
        <td>
          <?php echo $form['availability_notice']->renderError() ?>
          <?php echo $form['availability_notice'] ?>
        </td>
      </tr>
      <tr>
        <th><?php echo $form['availability_last_minute']->renderLabel() ?></th>
        <td>
          <?php echo $form['availability_last_minute']->renderError() ?>
          <?php echo $form['availability_last_minute'] ?>
        </td>
      </tr>
      <tr>
        <th><?php echo $form['availability_copilot']->renderLabel() ?></th>
        <td>
          <?php echo $form['availability_copilot']->renderError() ?>
          <?php echo $form['availability_copilot'] ?>
        </td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td>
          <?php echo $form['insurance_agreed']->renderError() ?>
          <?php echo $form['insurance_agreed'] ?>
        </td>
      </tr>
      <tr>
        <th><?php echo $form['volunteer_interest']->renderLabel() ?></th>
        <td>
          <?php echo $form['volunteer_interest']->renderError() ?>
          <?php echo $form['volunteer_interest'] ?>
        </td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td>
          <?php echo $form['company_business_category_id']->renderError() ?>
          <?php echo $form['company_business_category_id'] ?>
        </td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td>
          <?php echo $form['method_of_payment_id']->renderError() ?>
          <?php echo $form['method_of_payment_id'] ?>
        </td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td>
          <?php echo $form['ccard_error_code']->renderError() ?>
          <?php echo $form['ccard_error_code'] ?>
        </td>
      </tr>
      <tr>
        <th><?php echo $form['ccard_avs_result']->renderLabel() ?></th>
        <td>
          <?php echo $form['ccard_avs_result']->renderError() ?>
          <?php echo $form['ccard_avs_result'] ?>
        </td>
      </tr>
      <tr>
        <th><?php echo $form['processed_date']->renderLabel() ?></th>
        <td>
          <?php echo $form['processed_date']->renderError() ?>
          <?php echo $form['processed_date'] ?>
        </td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td>
          <?php echo $form['novapointe_id']->renderError() ?>
          <?php echo $form['novapointe_id'] ?>
        </td>
      </tr>
      <tr>
        <th><?php echo $form['premium_ship_date']->renderLabel() ?></th>
        <td>
          <?php echo $form['premium_ship_date']->renderError() ?>
          <?php echo $form['premium_ship_date'] ?>
        </td>
      </tr>
      <tr>
        <th><?php echo $form['premium_ship_method']->renderLabel() ?></th>
        <td>
          <?php echo $form['premium_ship_method']->renderError() ?>
          <?php echo $form['premium_ship_method'] ?>
        </td>
      </tr>
      <tr>
        <th><?php echo $form['premium_ship_cost']->renderLabel() ?></th>
        <td>
          <?php echo $form['premium_ship_cost']->renderError() ?>
          <?php echo $form['premium_ship_cost'] ?>
        </td>
      </tr>
      <tr>
        <th><?php echo $form['premium_ship_tracking_number']->renderLabel() ?></th>
        <td>
          <?php echo $form['premium_ship_tracking_number']->renderError() ?>
          <?php echo $form['premium_ship_tracking_number'] ?>
        </td>
      </tr>
      <tr>
        <th><?php echo $form['referer_name']->renderLabel() ?></th>
        <td>
          <?php echo $form['referer_name']->renderError() ?>
          <?php echo $form['referer_name'] ?>
        </td>
      </tr>
      <tr>
        <th><?php echo $form['referral_session_id']->renderLabel() ?></th>
        <td>
          <?php echo $form['referral_session_id']->renderError() ?>
          <?php echo $form['referral_session_id'] ?>
        </td>
      </tr>
      <tr>
        <th><?php echo $form['aircraft_third_id']->renderLabel() ?></th>
        <td>
          <?php echo $form['aircraft_third_id']->renderError() ?>
          <?php echo $form['aircraft_third_id'] ?>
        </td>
      </tr>
      <tr>
        <th><?php echo $form['aircraft_third_own']->renderLabel() ?></th>
        <td>
          <?php echo $form['aircraft_third_own']->renderError() ?>
          <?php echo $form['aircraft_third_own'] ?>
        </td>
      </tr>
      <tr>
        <th><?php echo $form['aircraft_third_ice']->renderLabel() ?></th>
        <td>
          <?php echo $form['aircraft_third_ice']->renderError() ?>
          <?php echo $form['aircraft_third_ice'] ?>
        </td>
      </tr>
      <tr>
        <th><?php echo $form['aircraft_third_seats']->renderLabel() ?></th>
        <td>
          <?php echo $form['aircraft_third_seats']->renderError() ?>
          <?php echo $form['aircraft_third_seats'] ?>
        </td>
      </tr>
      <tr>
        <th><?php echo $form['aircraft_third_n_number']->renderLabel() ?></th>
        <td>
          <?php echo $form['aircraft_third_n_number']->renderError() ?>
          <?php echo $form['aircraft_third_n_number'] ?>
        </td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td>
          <?php echo $form['mission_email_optin']->renderError() ?>
          <?php echo $form['mission_email_optin'] ?>
        </td>
      </tr>
      <tr>
        <th><?php echo $form['hseats_interest']->renderLabel() ?></th>
        <td>
          <?php echo $form['hseats_interest']->renderError() ?>
          <?php echo $form['hseats_interest'] ?>
        </td>
      </tr>
      <tr>
        <th><?php echo $form['master_application_id']->renderLabel() ?></th>
        <td>
          <?php echo $form['master_application_id']->renderError() ?>
          <?php echo $form['master_application_id'] ?>
        </td>
      </tr>
      <tr>
        <th><?php echo $form['master_member_id']->renderLabel() ?></th>
        <td>
          <?php echo $form['master_member_id']->renderError() ?>
          <?php echo $form['master_member_id'] ?>
        </td>
      </tr>
      <tr>
        <th><?php echo $form['referral_source_other']->renderLabel() ?></th>
        <td>
          <?php echo $form['referral_source_other']->renderError() ?>
          <?php echo $form['referral_source_other'] ?>
        </td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td>
          <?php echo $form['emergency_contact_name']->renderError() ?>
          <?php echo $form['emergency_contact_name'] ?>
        </td>
      </tr>
      <tr>
        <th><?php echo $form['emergency_contact_phone']->renderLabel() ?></th>
        <td>
          <?php echo $form['emergency_contact_phone']->renderError() ?>
          <?php echo $form['emergency_contact_phone'] ?>
        </td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td>
          <?php echo $form['drivers_license_state']->renderError() ?>
          <?php echo $form['drivers_license_state'] ?>
        </td>
      </tr>
      <tr>
        <th><?php echo $form['drivers_license_number']->renderLabel() ?></th>
        <td>
          <?php echo $form['drivers_license_number']->renderError() ?>
          <?php echo $form['drivers_license_number'] ?>
        </td>
      </tr>
    </tbody>
  </table>
