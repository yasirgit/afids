...
<div class="step" style="display: block;">
  <div class="passenger-form">
    <form action="<?php echo url_for('renewal/processStep1'.(!$form->getObject()->isNew() ? '?id='.$form->getObject()->getId() : '').($form->getObject()->getPersonId() ? '&person_id='.$form->getObject()->getPersonId() : '')) ?>" method="post" <?php $form->isMultipart() and print 'enctype="multipart/form-data" ' ?>>
      ...
      <div class="box">
        ...
        <div class="wrap">
          ...
          <?php if ($person) echo content_tag('div', $person->getMiddleName(), array('class' => 'field_help'))?>
        </div>
        <div class="wrap">
        ...
        <div class="wrap">
          ...
          <?php if ($person) echo content_tag('div', $person->getSuffix(), array('class' => 'field_help'))?>
        </div>
        <div class="wrap">
          <?php echo $form['nickname']->renderLabel() ?>
          <?php echo $form['nickname'] ?>
          <?php echo $form['nickname']->renderError() ?>
          <?php if ($person) echo content_tag('div', $person->getNickname(), array('class' => 'field_help'))?>
        </div>
        <div class="wrap">
      ...
      <div class="box alt">
        ...
        <div class="wrap">
          ...
          <?php if ($person) echo content_tag('div', $person->getFaxPhone2(), array('class' => 'field_help'))?>
        </div>
        <div class="wrap">
          ...
          <?php if ($person) echo content_tag('div', $person->getOtherPhone(), array('class' => 'field_help'))?>
        </div>
        <div class="wrap">
          <?php echo $form['pager_email']->renderLabel() ?>
          <?php echo $form['pager_email'] ?>
          <?php echo $form['pager_email']->renderError() ?>
          <?php if ($person) echo content_tag('div', $person->getPagerEmail(), array('class' => 'field_help'))?>
        </div>
        <div class="wrap">
