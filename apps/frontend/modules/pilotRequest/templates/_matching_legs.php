			...
			<td>
                            <?php if($display == 'leg-info'):?>
                                ...
                                <?php  if( $leg->getLegNumber() == 1 ){ ?>
                                    <div id="_edit_comment<?php echo $mission->getId() ?>" sytle="background-color: rgb(255, 255, 153); display: none;">--<?php echo $mission->getMissionSpecificComments();?>--</div>
                                    <?php echo input_in_place_editor_tag('_edit_comment'.$mission->getId(), 'pilotRequest/saveCommentMission?id='.$mission->getId(),array('save_text'=>'Save')) ?>
                                <?php } else { ?>
...
<div class="holder" style="text-align: center">
  There is no mission available mached your criteria
</div>
<?php endif;?>
</div>
