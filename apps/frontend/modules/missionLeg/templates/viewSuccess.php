        ...
        <div class="bg">
          <div class="holder">
            ...
            <table border="0" cellpadding="2" width="100%" cellspacing="0">
              <tr>
                <td width="50%" valign="top" align="left"><strong><small>Relationship</small></strong></td>
                <td width="25%" valign="top" align="right"><strong><small>Age</small></strong></td>
                <td width="25%" valign="top" align="right"><strong><small>Weight</small></strong></td>
              </tr>
          ...
          <div class="holder">
            ...
            <?php if(isset($pilot)):?>
                ...
                <?php if(count($aircrafts)):?>
                      <?php if ($sf_user->hasCredential(array('Administrator'), false) && isset($member)):?><a href="<?php echo url_for('@paircraft_create?leg='.$leg->getId().'&member='.$member->getId())?>" class="link-add"></a><?php endif?>
                      <br/>
     ...
     <div class="preferences" style="width:325px; float:left;">
      <div class="frame">
        <div class="bg">
          <div class="holder">
            <h4>Coordinator</h4>
            <?php if(isset($coordiPerson)):?>
               <?php $person_co = $coordiPerson->getMember()->getPerson();?>
               <?php if(isset($person_co)):?>
                <dl class="person-data">
                    <dt>Name </dt>
                    <dd><?php echo $person_co->getTitle().' '.$person_co->getFirstName().' '.$person_co->getLastName()?></dd>
                </dl>
               <?php endif?>
            <?php else:?>
                <dl class="person-data">
...
<div>
    ...
    <div style="clear:both;">
        <a href="<?php echo url_for('@print_mission_leg?id='.$leg->getId())?>" class="btn-action"><span> Printable Mission Leg</span><strong>&nbsp;</strong></a>
    </div>
    <br/>
    <div style="clear:both; height:15px;">&nbsp;</div>
    <div style="clear:both;">
    <span>
     <form action="<?php echo url_for('@send_leg_email')?>"  method="get" id="mail_form">
        <input type="hidden" name="leg_id" value="<?php echo $leg->getId()?>"/>
        <a href="#" onclick="jQuery('#mail_form').submit(); return false;" class="btn-action"><span>Email this Mission Leg</span><strong>&nbsp;</strong></a>
      </form>
    </span>
    </div>
</div>