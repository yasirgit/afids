...
?>
<?php use_helper('Javascript', 'Form', 'jQuery') ?>

<h2>Missions Available</h2>
<div class="missions-available">
  <?php include_partial('pilotRequest/filter', array(
    'pager' => $pager,
    ...
    'action_url' => '@available_camps',
    'error_min_eff' => $error_min_eff,
    'ident' => $ident
  ))?>

  <?php include_partial('matching_camps', array('miss_array' => $miss_array, 'member' => $member, 'airport' => $airport))?>

  <?php include_partial('pilotRequest/interested_legs', array('missions' => $missions, 'member' => $member, 'airport' => $airport))?>
</div>
