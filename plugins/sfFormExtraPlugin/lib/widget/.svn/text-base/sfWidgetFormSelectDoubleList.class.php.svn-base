...
class sfWidgetFormSelectDoubleList extends sfWidgetForm
{
   ...
   *  * unassociate_class:  The class for the unassociate link
   *  * associate:          The HTML for the associate link
   *  * associate_class:  The class for the associate link
...
EOF
  ...
  public function render($name, $value = null, $attributes = array(), $errors = array())
  {
    ...
    return strtr($this->getOption('template'), array(
      ...
      '%associate%'          => sprintf('<a href="#" onclick="%s" class="%s">%s</a>', 'sfDoubleList.move(\'unassociated_'.$this->generateId($name).'\', \''.$this->generateId($name).'\'); return false;', $this->getOption('associate_class'),$this->getOption('associate')),
      '%unassociate%'        => sprintf('<a href="#" onclick="%s" class="%s">%s</a>', 'sfDoubleList.move(\''.$this->generateId($name).'\', \'unassociated_'.$this->generateId($name).'\'); return false;', $this->getOption('unassociate_class'), $this->getOption('unassociate')),
